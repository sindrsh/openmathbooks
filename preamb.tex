...
\newcommand{\reg}[2][]{\begin{tcolorbox}[boxrule=0.3 mm,arc=0mm,colback=blue!3] {\refstepcounter{rg}\phantomsection \large \textbf{Regel \therg \;#1} \vspace{5 pt}}\newline #2  \end{tcolorbox}\vspace{-5pt}}
\newcommand{\regdef}[2][]{\begin{tcolorbox}[boxrule=0.3 mm,arc=0mm,colback=blue!3] {\refstepcounter{rg}\phantomsection \large \textbf{Definisjon \therg \;#1} \vspace{5 pt}}\newline #2  \end{tcolorbox}\vspace{-5pt}}
...
\newcommand{\am}{\net{https://sindrsh.github.io/FirstPrinciplesOfMath/}{AM}}
...
\begin{center}
	\begin{tabular}{c|c}
		E & Eksempeloppgave \\
		V & Eksamen fra vårsemesteret\\
		H & Eksamen fra høstsemesteret \\
		XX & Eksamen ble gitt i år 20XX
	\end{tabular}
\end{center}
...
% outline word
\newcommand{\outl}[1]{{\color{Emerald}#1}}
