...
\newpage
\grubeksoprecc{gv26d1opg11}{GV26} \vso
\abc{
\item Finn arealet til trapeset $\square ABCD$ uttrykt ved $x$.
\item Finn $x$ når arealet til $\square ABCD$ er 18.
}
\fig{gv26d1opg11}

\grubeksoprecc{gv26d2opg6}{GV26}
Gitt følgende prosedyre:
\begin{center}
	\begin{tabular}{|m{0.75cm} | m{5cm} | m{3cm}|}
		\hline
		\textbf{Steg}&	&  \textbf{Eksempel} \\
		\hline
		1 & Velg to positive tall & 3 og 5 \\  \hline
		2 & Velg ett av tallene, multipliser det med ti, & $3\cdot10+5=35$\\
		& og legg til det andre tallet. & \\ \hline
		3 & Velg det andre tallet, multipliser det med ti, og legg til det første tallet. & $5\cdot10+3=53$ \\ \hline
		4 & Summer tallene fra steg to og tre. & $35+53=88$\\ \hline
		5 & Legg sammen de to ensifrede tallene du
		valgte. & $3+5=8$ \\ \hline
		6 & Divider summen av tallene fra steg fire med summen fra steg 5. & $\dfrac{88}{8}=11$ \\ \hline
	\end{tabular}
\end{center}
\abc{
\item Gjenta prosedyren med to andre tall enn 3 og 5.
\item Vis at resultatet i steg 6 alltid\footnote{Unntaket er hvis summen av de to tallene i steg 1 er 0.} vil være lik 11.
}
\newpage
\grubeksoprecc{1pv26d1opg7}{1PV26}
I Figur 1 er antallet linjestykker 4. I Figur 2 er antallet linjestykker 12. Finn en formel for antall linjestykker i Figur $n$.
\fig{1pv26d1opg12}
...
\begin{center}
	...
	\begin{tabular}{|l | r| r| r|}
		\hline
		Figur& Vertikale & Horisontale & Sum \\ 
		& linjestykker & linjestykker & \\ \hline
		1 & $2=2\cdot1$ & $2=2\cdot1$ & $2\cdot1+2\cdot1=2(2\cdot1)=4\phantom{0}$ \\
		2 & $6=3\cdot2$ & $6=3\cdot2$ & $3\cdot2+3\cdot2=2(3\cdot2)=12$ \\
		3 & $12=4\cdot3$ & $12=4\cdot3$ & $4\cdot3+4\cdot3=2(4\cdot3)=24$ \\
		$n$ & $(n+1)n$ & $(n+1)n$ & $(n+1)n+(n+1)n=2(n+1)n$
	\end{tabular}
\end{center}
