...
\opr{opgprimfakt}
\abch{
	\item $ 2\cdot 2\cdot2\cdot2\cdot 5 $ 
	\item $ 2\cdot3 \cdot5 $
	\item $ 2\cdot2\cdot2\cdot 5 $
	\item $2\cdot5\cdot7$
	\item $2\cdot3\cdot7$
	\item $2\cdot2\cdot2\cdot2\cdot2$
	\item $2\cdot2\cdot3\cdot7$
	\item $2\cdot3\cdot3\cdot5$
} 
...
\abch{ 
	...
	\item $ 8\cdot 4 $, $ 16\cdot 2 $, $ 8\cdot2\cdot2 $
...
\opr{opgnegfyllinn}
\abch{
	\item 9 har retning mot høyre og lengde 9.
	\item 4 har retning mot høyre og lengde 4
	\item $-3$ har retning mot venstre og lengde 3
	\item 12 har retning mot høyre og lengde 12
...
\opr{opgrekcomma1right}
\abch{
	\item 57,9 \item 32 \item 90
}

\opr{opgrekcomma2right}
\abch{
	\item 314,6 \item 210 \item 500
}

\opr{opgrekcomma3right}
\abch{
	\item 4010 \item 4100 \item 53\,000 
}

\opr{opgrekcomma1left}
\abch{
	\item 9 \item 3,252 \item 0,9
}

\opr{opgrekcomma2left}
\abch{
	\item 4,146 \item 0,021 \item 0,07
}

\opr{opgrekcomma3left}
\abch{
	\item 0,00401 \item 0,0041 \item 0,053 
}
...
\opr{funkopgligset}
\abch{
	\item \eqref{eks3a} og \eqref{eks3b} gir hver for seg en likning som beskriver en rett linje. Disse linjene kan også representeres ved $ f $ og $ g $ slik som de er definert.
	\item $ x=7 $ og $ y=2 $.
}
...
\grubr{opgfunk3ukjente}
$f(x)=2x^2-5x+4$

\grubr{opgettpunkt}
\abch{
	\item $f(x)=3x-5$ \item \selos}
...
\item $x_1=-2$, $x_2=4$
\item 3 for begge.
\item $A=(-3, 7)$, $B=(5, 7)$. Horisontalavstanden er 4 for begge.
\item De har lik $y$-verdi.
\item $x=47$
}

\grubr{gv25d2opg1}
$\text{Antall blå kvadrater}=(n+2)^2-n^2$ (eventuelt $4(n+1)$)
...
\abch{
\item 26
\item Linja er parallell med $AB$. Høyden vil være uendret.
}
...
\grubr{opggeosemisirkfirk} $10$

\grubr{opgdoublear} \selos

\grubr{opglikbmidtn} \selos

\grubr{opgtresirkar} \selos

\grubr{opggeosirkfirk} $\frac{5}{2}$

\grubr{opggeolikar} \selos

\grubr{opggeoperplin} \selos
