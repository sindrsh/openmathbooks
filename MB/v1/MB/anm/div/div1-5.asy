...
label("$\color{black}\cdot\,4$",sh*(b,y),W);
...
label("$\color{blue}40$",sh*(b+2dx,y-dy),W);

label("$\color{black}7$",sh*(b,y-2dy),W);
label("$\color{blue}28$",sh*(b+dx,y-2dy),W);

label("$\color{deepgreen}68$",sh*(b+2dx,y-2dy),W);
/*
