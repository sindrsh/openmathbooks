...
label("2",sh*(0,0));
label("6",sh*(dx,0),blue);
label("3",sh*(2dx,0));

label("$-$",sh*(-2dx,dy));
label("$=$",sh*(-2dx,2dy-0.025));

label("7",sh*(dx,dy),red);
label("4",sh*(2dx,dy));
...
label("${\color{black}10}+{\color{black}3}-{\color{black}4}=\color{black}9$",sh2*(0,0),align=W,fontsize(10pt));
...
label("${\color{blue}10}+{\color{blue}5}-{\color{red}7}=\color{heavygreen}8$",sh2*(0,1.25dy),align=W,fontsize(10pt));

label("\color{heavygreen}8",sh*(dx,2dy));
