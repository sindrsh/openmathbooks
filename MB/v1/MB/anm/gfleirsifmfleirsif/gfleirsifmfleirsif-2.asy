...
label(sh*(x-1.2,1),"${279}\cdot {\color{blue}3}4=$",align=E);

/*
transform sh = shift(-3,0);
label(sh*(x,y),"${200}\cdot30$",align=W);

label(sh*(x+dx,y),"$=\color{blue}6000$",align=E);

label(sh*(x,y-dy),"${\phantom{0}70}\cdot30$",align=W);

label(sh*(x+dx,y-dy),"$=\color{blue}2100$",align=E);

label(sh*(x,y-2dy),"${\phantom{0}9}\cdot30$",align=W);

label(sh*(x+dx,y-2dy),"$=\color{blue}\phantom{0}270$",align=E);
