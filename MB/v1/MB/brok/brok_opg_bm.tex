...
\op{opgbrfigs}
Skriv brøken som figuren viser når hele figuren har verdi 1. \os
\abch{
	\item \includegraphics{\figp{opgbr_a}}
	\item \includegraphics{\figp{opgbr_b}}
	\item \includegraphics{\figp{opgbr_c}}
	\item \includegraphics{\figp{opgbr_d}}
}

\op{opgbrtallin}
Skriv brøken markert med rødt.
\abc{
...
Utvid\os
\abch{
\item $\displaystyle \frac{10}{3} $ med 2.	
\item $\displaystyle \frac{3}{4} $ med 3.
\item $\displaystyle \frac{3}{7} $ med 4.
} \vsk

\abchs{3}{
\item $\displaystyle \frac{9}{8} $ med 5.
\item $\displaystyle \frac{9}{5} $ med 6.
\item $\displaystyle \frac{11}{4} $ med 7.
}

\op{opgbrutvidtil}
Utvid
\abc{
	\item $\displaystyle \frac{7}{3} $ til en brøk med 15 som nevner.
	\item $\displaystyle \frac{3}{4} $ til en brøk med 32 som nevner.
	\item $\displaystyle \frac{10}{9} $ til en brøk med 63 som nevner.
}

\op{opgbrfork}
Forkort\os
\abch{
	\item $\displaystyle \frac{14}{26} $ med 2.	
	\item $\displaystyle \frac{15}{12} $ med 3.
	\item $\displaystyle \frac{20}{16} $ med 4.
} \vsk

\abchs{3}{
	\item $\displaystyle \frac{35}{50} $ med 5.
	\item $\displaystyle \frac{54}{18} $ med 6.
	\item $\displaystyle \frac{49}{63} $ med 7.
}

\op{opgbrforktil}
Forkort
\abc{
	\item $\displaystyle \frac{27}{12} $ til en brøk med 4 som nevner.
	\item $\displaystyle \frac{36}{20} $ til en brøk med 5 som nevner.
	\item $\displaystyle \frac{18}{63} $ til en brøk med 7 som nevner.
}
\newpage
\op{opgbrsjekk}
Undersøk om brøkene har lik eller ulik verdi.\os
\abch{
\item $\displaystyle\frac{4}{3}$ og $\frac{6}{5}$
\item $\displaystyle\frac{20}{50}$ og $\frac{2}{5}$
\item $\displaystyle\frac{7}{3}$ og $\frac{9}{5}$
}
...
\rknut \os
\abch{
\item $\displaystyle \frac{3}{7}+2$
\item $\displaystyle 5+\frac{9}{4}$
}
...
\op{opgbrdelheldel}
Utnytt at telleren er delelig med divisoren, og regn ut. \os
\abch{
\item $\displaystyle \frac{4}{3}:2$
\item $\displaystyle \frac{6}{5}:3$
\item $\displaystyle \frac{28}{3}:7$
\item $\displaystyle \frac{36}{13}:9$
}
...
\op{kansfakt}
Kanseller så mange faktorer som mulig i brøkene.\os 
\abch{
...
Forkort brøkene så mye som mulig.\os
\abch{
	\item $ \dfrac{28}{16} $
	\item $ \dfrac{18}{42} $
	\item $ \dfrac{24}{36} $
...
Utnytt at nevneren er en faktor i tallet det blir ganget med, og regn ut\os
\abch{
...
\op{opgheildelbrfork}
Regn ut, og forkort brøkene så mye som mulig. \os
\abch{
	\item $ 4:\dfrac{8}{9} $
	\item $ 7:\dfrac{21}{5} $
	\item $ 10:\dfrac{5}{3} $
...
\mers{Her har vi valgt å primtalsfaktorisere alle tallene, men man trenger ikke gjøre det hvis mans ser hvilke faktorer som er felles for tellerne og nevnerne.}
} \regv

Utnytt at tellerne og nevnerne har felles faktorer, og regn ut. \os
\abch{
...
Se tilbake til svarene for oppgave \refops{opgbrverdiikkedelelig}{\color{NavyBlue}a)\,-\,g)}. Fyll inn heltallet som mangler der det står ''\_''.
\abcs{4}{
