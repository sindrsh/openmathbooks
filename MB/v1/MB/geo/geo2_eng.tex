...
\begin{figure}
	\centering
	\subfloat[6-gon]{\includegraphics[]{\figp{geo9}}}\qquad\qquad
	\subfloat[12-gon]{\includegraphics[]{\figp{geo9a}}}	
\end{figure}
...
\begin{figure}
	\centering
	\subfloat[A 6-gon and a 12-gon together with a triangle formed by the circle center and one side of the 12-gon.]{\includegraphics[]{\figp{geo9g}}}\qquad\qquad
	\subfloat[The triangle from figure \textsl{(a)}.]{\includegraphics[]{\figp{geo9h}}}	
\end{figure}
...
\begin{figure}
	\centering
	\subfloat[6-gon]{\includegraphics[scale=0.75]{\figp{geo9}}}\quad
	\subfloat[12-gon]{\includegraphics[scale=0.75]{\figp{geo9a}}}\quad	
	\subfloat[24-gon]{\includegraphics[scale=0.75]{\figp{geo9i}}}\quad	\\
	\subfloat[48-gon]{\includegraphics[scale=0.75]{\figp{geo9j}}}\quad	
	\subfloat[96-gon]{\includegraphics[scale=0.75]{\figp{geo9k}}}		
\end{figure}
...
A computer has no problems performing calculations\footnote{For those interested in computer programming; the iteration algorithm must be altered in order to avoid instabilities when the number of sides are large.} on a polygon with extremely    many sides. Calculating the perimeter of a 201\,326\,592-gong yields
