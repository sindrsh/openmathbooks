...
\info{Oppstilling versus tabellmetoden}{
	Ved første augekast kan kanskje tabellmetoden sjå ut som ein innvikla måte å rekne addisjon på samanlikna med oppstilling, men med øving vil mange oppdage at tabellmetoden betrer evnen til hoderekning. Styrkene til tabellmetoden kommer aller best til sin rett når det er snakk om å utføre subtraksjon eller divisjon.  
}
...
\fork{Eksempel 2}{ \vs
	...
	\begin{enumerate}[label=(\alph*)]
		\item Vi merkar oss at 7 er større enn 3, derfor tar vi 1 tiar frå dei 9 på tiarplassen. Dette markerer vi ved å sette ein strek over 9. Så finn vi differansen mellom einarane: $ {13-7=6} $
		\item Sidan vi tok 1 frå dei 9 tiarane, er der no berre 8 tiarar. Vi finn differansen mellom tiarane: $ {8-5=3} $.
	\end{enumerate}
}
\subsubsection{Tabellmetoden}
...
\info{Tips}{
Det kan vere lurt å sjå tilbake på utrekningar gjort med tabellmetoden for å tenke over om ein kunne valt tal på ein betre måte. I \textsl{Eksempel 1} på side \pageref{ekstbldiv} kunne vi starta med å gonge med 20. Dette er omlag like enkelt som å gonge med 10, og det ville ha bringa oss nærare målet.
}
\newpage
...
\newpage
\subsubsection{Divisjon med desimaltal som svar}
\eks[1]{
...
\subsubsection{Overslagsrekning oppsummert}
