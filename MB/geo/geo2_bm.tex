...
\newpage
\spr{
Det irrasjonale tallet 3,141592653589793... er så viktig i matematikk at det har sitt eget symbol, nemlig \sym{$\pi$}. Altså er
...
\end{itemize}
Ligningen vi satt opp i eksempelet ender med at vi ganger forholdstallet med den samsvarende siden. Dette vil alltid være tilfellet så lenge bare én av sidelengdene er ukjent. I steden for å sette opp en ligning, kunne vi altså direkte regnet ut at $EF=2\cdot3=6$.
}
\newpage
\info{Merk}{
