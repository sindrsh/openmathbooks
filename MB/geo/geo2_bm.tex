...
\begin{document}
\section{Fromler for areal, omkrets og volum}
...
\reg[\volforml \label{volforml}]{ 
	Volumet $ V $ til en firkantet prisme eller en sylinder med grunnflateareal $ G $ og høyde $ h $ er
	\[ V = G h \]
	\begin{figure}
		\centering
		\footnotesize
