...
Forklaringen for denne regelen finner du i løsningsforslaget til \grubr{trekulik}.
}
...
\info{Bredde og lengde}{Ofte blir ordene \outl{bredde}\index{bredde} og \outl{lengde}\index{lengde} brukt om grunnlinja og høyden i et rektangel.}
\eks[1]{
...
\newpage
\textit{3) Tilfellet der høyden ligg utenfor trekanten} \os
...
\fig{3db}
Mens et rektangel sies å ha en bredde og en høyde, kan vi si at boksen over har en bredde, en høyde \textsl{og} en lengde (dybde). \vsk
