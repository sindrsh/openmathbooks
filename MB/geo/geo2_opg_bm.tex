...
\op{opggeooytright2}
Koordinatene til hjørnene i trekanter er oppgitt. Tegn trekantene inn i et koordinatsystem, og avgjør om de er rettvinklede eller ikke.
\abc{
\item $(0, 0)$, $(2, 1)$ og $(0, 5)$
\item $(2, 0)$, $(3, 3)$ og $(0, 1)$
\item $(-2, 0)$, $(-2, -1)$ og $(2, 3)$
...
$S$ er sentrum i en halvsirkel med diameter 10. Den største firkanten er et kvadrat. Finn arealet til den blå trekanten.
\fig{semisirkfirk}
...
\newpage
\grubop{opggeoperplin}
Gitt funksjonene $f(x)=4x$ og $g(x)=-\frac{1}{4}x$. Vis at grafene til $f$ og $g$ står vinkelrette på hverandre.
