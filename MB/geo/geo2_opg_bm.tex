...
\abc{
\item Vis at $ \frac{a}{b}=\sqrt{2}+\sqrt{6} $.\\ {\footnotesize \textit{Obs! For å løse denne oppgaven er det godt mulig du vil få bruk for \textit{abc}-formelen, som du finner i \tmen.}}
\fig{opggeosin15inv}
