...
\op{opggeoareaomv} \vs
\abc{
\item Et parallellogram med høyde $h$ har areal $3h$. Hva er verdien til grunnlinjen?
\item Et rektangel med grunnlinje $a$ har areal $9ab$. Hva er uttrykket for høyden?
\item En trekant med grunnlinje $g$ har areal $5g$. Hva er verdien til høyden?
}
...
\op{opggeocircomv} \vs
\abc{
\item En sirkel har omkrets $20\pi$. Hva er radien til sirkelen?
\item En sirkel har areal $81\pi$. Hva er radien til sirkelen?
\item En sirkel har omkrets $4k\pi $. Hva er uttrykket for radien til sirkelen?
\item En sirkel har areal $100\pi a^2$. Hva er uttrykket for radien til sirkelen?}
...
\item Hva er forholdet mellom omkretsen til den største sirkelen og omkretsen til den minste sirkelen.
\item Hva er forholdet mellom arealet til den største sirkelen og arealet til den minste sirkelen?
}
...
\abc{
	...
	\item Hva er forholdet mellom volumet til den største kula og volumet til den minste kula?
}
\op{opggeovolforholdgeneral}
En kule har radius $ r $ og en annen kule har radius $ ar $, hvor $ {a>1} $. Hva er forholdet mellom volumet til den største kula og volumet til den minste kula?
...
\abc{
\item Skriv de samsvarende sidene i de to trekantene.
...
\item Skriv de samsvarende sidene i $\triangle ABC$ og $\triangle EDC$.
...
\op{opggeopyt}
En rettvinklet trekant har sidelengder $a$, $b$ og $c$, der $c$ er lengden til den lengste siden. Finn den manglende sidelengden når du vet at
\abc{
\item $a=6$ og $b=8$
\item $a=8$ og $b=15$
\item $a=20$ og $c=25$
...
\newpage
\op{opgpytnamed}
Finn sidelengden som mangler. \os
\abch{
