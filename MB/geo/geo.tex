...
\fig{vink3a}
\newpage
Ein vinkel som er større enn $ 90^\circ $ kallast ein \outl{butt/stump vinkel}\index{vinkel!butt}, og ein vinkel som er mindre enn $ 90^\circ $ kallast ein \outl{spiss vinkel}.\index{vinkel!spiss}
\fig{vink5}\vsk
...
\newpage
\reg[\topv \label{toppv}]{
	To motståande vinklar med felles toppunkt kallast \outl{toppvinklar}\index{toppvinkel}. Toppvinklar er like store.
	\fig{vink4a}
}
