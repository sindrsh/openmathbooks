...
\fork{Eksempel 2}{
	...
	\begin{enumerate}[label=\alph*)]
		...
		\item Vi legger sammen tierne: $ {7+8=15} $. Siden 10 tiere er lik 100, legger vi til 1 på hundreplassen, og skriver opp de resterende 5 tierne på tierplassen.
...
\fork{Eksempel 2}{ \vs
	...
	\begin{enumerate}[label=(\alph*)]
		\item 7 er større enn 3, derfor tar vi 1 tier fra de 9 på tierplassen. Dette markerer vi ved å sette en strek over 9. Så finner vi differansen mellom enerne: $ {13-7=6} $
		\item Siden vi tok 1 fra de 9 tierne, er der nå bare 8 tiere. Vi finner differansen mellom tierne: $ {8-5=3} $.
	\end{enumerate}
}
\newpage
\subsubsection{Tabellmetoden}
Tabellmetoden for subtraksjon baserer seg på at subtraksjon er den omvendte operasjonen av addisjon. For eksempel, svaret på spørsmålet ''Hva er $ 83-67 $?'' er det samme som svaret på spørsmålet ''Hvor mye må jeg legge til på 67 for å få 83?''. Med tabellmetoden følger du ingen spesiell regel underveis, men velger selv tallene du mener passer best for å nå målet.\\
\begin{center}
\parbox{0.35\linewidth}{
\eks[2]{
	$ \colb{83}-\colr{67}=\colo{16} $	 \vsk
...
\parbox{0.35\linewidth}{
\eks[1]{
	$ \colb{789}-\colr{324}=\colo{465} $	 \vsk
...
\fork{Eksempel 1}{
	...
	\end{figure}
	\begin{enumerate}[label=(\alph*)]
		\item Vi starter med 67.
		\item Vi legger til 3, og får $ {67+3=70} $
		\item Vi legger til 13, og får $ {70+13=83} $. Da er vi framme\\ på 83.
		\item Vi summerer tallene vi har lagt til:  $ {3+13=16} $
	\end{enumerate}
}
\newpage
\fork{Eksempel 2}{
...
\begin{enumerate}[label=(\alph*)]
	...
	\item Vi legger til 5, og får $ {324+5=329} $
	\item Vi legger til 60, og får $ {329+60=389} $
	\item Vi legger til 400, og får $ {389+400=789} $. Da er vi framme på 789.
	\item Vi summerer tallene vi har lagt til:  $ {5+60+400=465} $
\end{enumerate}
}

\section{Flytting av komma}
I kommende seksjoner skal vi bruke en teknikk vi skal kalle ''flytting av komma''. Denne metoden handler om å flytte komma et visst antall ''plasser''. Det vi her mener med ''plasser'' er plasser i titallssystemet (se \refsec{tallsiff}).
\reg[Flytting av komma]{
Hvis vi flytter komma slik at komma står helt til høyre, kan komma fjernes. \vsk

Hvis vi flytter komma slik at 0-er står til venstre for både komma og alle andre siffer, skal disse 0-ene fjernes.\vsk

Hvis vi flytter komma forbi plasser uten siffer, må vi skrive 0 på disse plassene.\vsk

Hvis vi flytter komma slik at komma står helt til venstre, må vi skrive 0 foran komma. \vsk

Flytter vi komma i et heltall, tar vi utgangspunkt i at komma står helt til høyre.
}
\eks[1]{
Gitt tallet $2,46$. \os

Flytter vi komma to plasser til høyre, får vi $246,=246$.
\fig{komma1}
}
\eks[2]{
Gitt tallet $42,9$. \os

Flytter vi komma tre plasser til høyre, får vi $42900,=42\,900$.
\fig{komma2}
}
\newpage
\eks[3]{
Gitt tallet $0,001$. \os

Flytter vi komma seks plasser til høyre, får vi $0001000,=1\,000$
\fig{komma4}
}
\eks[4]{
Gitt tallet $8,4$.\os

Flytter vi komma en plass til venstre, får vi $,84=0,84$.
\fig{komma3}
}
\eks[5]{
Gitt tallet $5$.\os

Flytter vi komma tre plasser til venstre, får vi $0,005$.
\fig{komma5}
}
\eks[6]{
Gitt tallet $109$.\os

Flytter vi komma fire plasser til høyre, får vi $1\,090\,000$.
\fig{komma6}
}
\spr{Som nevnt, brukes punktum som desimaltegn i programmerings-språk. Mange programmeringsspråk godtar at man skriver punktum helst til venstre i et tall. For eksempel kan man skrive $\sym{\texttt{0.1}}$ som \sym{\texttt{.1}}.\vsk
	
Mange programmeringsspråk godtar også at man skriver \\ punktum helt til høyre i et tall, men da vil det ofte bety om tallet skal leses som et heltall eller ikke. For eksempel kan \sym{\texttt{1}} tolkes som et heltall, mens \sym{\texttt{1.0}} kan tolkes som et desimaltall. I programmering kan det være forskjell på et heltall og et desimaltall selv om de har lik verdi.
}
...
\eks[1]{\vsb 
	\alg{
		6\cdot 1\colb{0} &= 6\colb{0}\vn
		79\cdot 1\colb{0} &= 79\colb{0} \vn
		802\cdot1\colb{0}&=802\colb{0}
	}
}
\eks[2]{ \vsb 
\alg{ 
6\cdot1\colb{00} &= 6\colb{00} \vn
79\cdot1\colb{00} &= 7\,9\colb{00} \vn
802\cdot1\colb{00} &=80\,2\colb{00}
}
}
\eks[3]{ \vsb
\alg{ 
	6\cdot1\,\colb{000} &= 6\,\colb{000} \vn
	79\cdot1\colb{0\,000} &= 79\colb{0\,000} \vn
	802\cdot1\colb{00\,000} &=80\,2\colb{00\,000}
}
}
\newpage
\reg[Å gange desimaltall med 10, 100 osv. \label{gangdesmed10100}]{
	\vs
	\begin{itemize}
		\item Når man ganger et desimaltall med 10, får man svaret ved å flytte komma en plass til høyre.
		\item Når man ganger et desimaltall med 100, får man svaret ved å flytte komma to plasser til høyre.
		\item Det samme mønsteret gjelder for tallene 1\,000, 10\,000 osv.
	\end{itemize}
}
\eks[1]{\vsb
	\alg{
		7{\color{black},}9\cdot 10 &= 79{\color{black},}=79 \vn
		38{\color{black},}02\cdot10&=380{\color{black},}2 \vn
		0{\color{black},}57\cdot 10 &=05{\color{black},}7=5{\color{black},}7 \vn
		0{\color{black},}194\cdot 10&= 01{\color{black},}94=1{\color{black},}94
	}
}
\eks[2]{ \vsb
	\alg{
		7{\color{black},}9\cdot 100 &= 790{\color{black},}=790 \vn
		38{\color{black},}02\cdot100&=3802{\color{black},}=3\,802 \vn
		0{\color{black},}57\cdot 100 &=057{\color{black},}=57 \vn
		0{\color{black},}194\cdot 100&= 019{\color{black},}4=19{\color{black},}4
	}
}
\eks[3]{ \vsb
	\alg{
	7{\color{black},}9\cdot 1\,000 &= 7900{\color{black},}=7\,900 \vn
	38{\color{black},}02\cdot10\,000&=38020{\color{black},}=380\,200 \vn
	0{\color{black},}57\cdot 100\,000 &=57000{\color{black},}=57\,000
}
}
\info{Merk}{
...
Altså er
\alg{
91\cdot53&= (90+1)\cdot (50+3) 
}
Videre er 
{
\alg{
(90+1)\cdot (50+3) &=90\cdot50+1\cdot50+90\cdot3+1\cdot3
\\
&=4500+50+270+3\\
&=4823}
} 
...
Kompaktmetoden bygger på de samme prinsippene som ganging på utvidet form, men har en skrivemåte som gjør utregningen kortere. \regv
...
\begin{itemize}
	\item $ 9\cdot 4=36 $, da skriver vi 6 på enerplassen og 3 i mente.
...
\end{itemize} 
Vi regner ut summen (med mentene inkludert), som er 9486.
}
\newpage
\newpage
...
\st{
	\begin{enumerate}
		\item Flytt komma til høyre slik at begge tallene blir heltall.
		\item Regn ut gangestykket mellom heltallene.
		\item Flytt komma til venstre like mange plasser som du totalt flyttet komma til høyre.
	\end{enumerate}
}
\eks[1]{
	Regn ut $ 3,4\cdot2 $
	...
	\sv
	Vi flytter komma 1 plass til \textsl{høyre} i 3,4. Da får vi 34. Videre er
	\[ 34\cdot2=68 \]
...
\eks[2]{
	...
	\sv
	Vi flytter komma 3 plasser til \textsl{høyre} i 0,005. Da får  vi 5. Videre er
	\[ 5\cdot7=35 \]
...
\eks[1]{ \vsb
	\alg{
200:10&=200{\color{black},}0:10 \\&=20{\color{black},}00\\&=20	\vn
45:10&=45{\color{black},}0:10 \\&= 4{\color{black},}50 \\&=4{\color{black},}5
}
}
\eks[2]{ \vsb
	\alg{
		200:100&=200{\color{black},}0:100 \\&=2{\color{black},}000\\&=2	\vn
		45:100&=45{\color{black},}0:100 \\&= 0{\color{black},}450 \\&=0{\color{black},}45
	}
}
\newpage
\eks[3]{ \vsb
\alg{
143{\color{black},}7 :10 &= 14{\color{black},}37 \vn
143{\color{black},}7 :100 &= 1{\color{black},}437 \vn
143{\color{black},}7 :1\,000 &= 0{\color{black},}1437 
}
}
\eks[4]{ \vsb
\alg{
93{\color{black},}6:10 &= 9{\color{black},}36 \vn
93{\color{black},}6:100 &= 0{\color{black},}936 \vn
93{\color{black},}6:1\,000 &= 0{\color{black},}0936
}
}
\fork{Deling med 10, 100, 1\,000 osv.}{
Titallsystemet baserer seg på grupper av ti, hundre, tusen osv., og tideler, hundredeler og tusendeler osv (se \rref{titalsys}). Når man deler et tall med 10, vil alle enere i tallet bli til tideler, alle tiere bli til enere osv. Hvert siffer forskyves altså én plass mot høyre. Tilsvarende forskyves hvert siffer to plasser mot høyre når man deler med 100, tre plasser når man deler med 1\,000 osv.
}
...
\fork{Eksempel 1}{ \vs \vs
	...
	\end{figure}
	Figuren over viser mengden 92, som vi skal dele inn i 4 like store grupper. 
	\begin{itemize}
...
\newpage
\subsubsection{Tabellmetoden}
Tabellmetoden for divisjon baserer seg på at divisjon er den omvendte operasjonen av multiplikasjon. For eksempel er svaret på spørsmålet ''Hva er $ {76:4} $?'' det samme som svaret på spørsmålet ''Hvilket tall må jeg gange 4 med for å få 76?''. På samme måte som for \text{tabellmetoden} for subtraksjon er det opp til en selv å velge passende tall for å nå målet.
\begin{center}
	\label{ekstbldiv}
	\parbox{0.35\linewidth}{
		\eks[1]{
...
Det er langt fra alltid at svaret ved divisjon blir et heltall. En måte å uttrykke slike svar på, er å ved å bruke begrepet \outl{rest}\index{rest}. Begrepet er best forklart ved eksempel: \regv
\eks[1]{
	...
	\[ 11= \colb{2}\cdot 4 +\colg{3} \]	
	\fig{mod1}
	Dette betyr at
	\[ 11:4 =\text{\colb{2} og \colg{3} i rest}\]
}
\eks[2]{
	...
	19, er 6. $ {6\cdot 3 = 18} $, så da har vi $ 19-18=1 $ i rest.
	\[ 19= \colb{6}\cdot 3 +\colg{1} \]	
	\fig{mod2}
	Dette betyr at
	\[ 19:3 =\text{\colb{6} og \colg{1} i rest}\]
}
\newpage
\eks[3]{
	...
	\[ 94:4=\colb{23}\text{ og }\colg{2}\text{ i rest} \]
	\begin{figure}
		\centering
	...
	\begin{center}
		\begin{tabular}{r|r|r}
			...
			3& 12 &92 \\ \hline
			\colb{23}&
		\end{tabular} \qquad $ 94-92=\colg{2} $
	\end{center}
}
\spr{
...
\newpage
\subsubsection{Divisjon med blandet tall som svar}
\eks[1]{
...
\fork{Eksempel 1}{
	Det største tallet vi kan gange 4 med uten at produktet er større enn 11, er 2. Siden $11=2\cdot4+3$, er
	\[ 11:4=\frac{2\cdot4+3}{4}=\frac{2\cdot\cancel{4}}{\cancel{4}}+\frac{3}{4}=2+\frac{3}{4} \]
}
\newpage
...
\st{
\begin{enumerate}
\item Flytt komma til høyre slik at begge tallene blir heltall. Flytt gjerne komma til høyre i dividenden slik at den blir større enn divisoren.
\item Regn ut delestykket mellom heltallene.
\item Regn ut (det er snakk om antall plasser komma er flyttet)
\[\text{plasser flyttet i dividend}-\text{plasser flyttet i divisor} \]
Hvis svaret er positivt, flytt komma så mange plasser til \textsl{venstre} i svaret fra punkt 2. Hvis svaret er negativt, flytt komma så mange plasser til \textsl{høyre} i svaret fra punkt 2.
\end{enumerate}
}
\eks[1]{
Regn ut $ 9,2:4 $.
...
\sv
Vi flytter komma 1 plass til \textsl{høyre} i 9,2. Da får vi 92. Vi har at
\[ 92:4=23 \]
I tillegg er
\[ \text{plasser flyttet i dividend}-\text{plasser flyttet i divisor}=1-0=1 \]
Vi flytter komma 1 plass til \textsl{venstre} i 23. Da får vi 2,3. Altså er
\[ 9,2:4=2,3 \]
}
\newpage
\eks[2]{
Regn ut $4,06:0,00002$.

\sv
Vi flytter komma 2 plasser til \textsl{høyre} i 4,06. Da får vi 406. Vi flytter komma 5 plasser til \textsl{høyre} i 0,00002. Da får vi 2. Vi har at
\[ 406:2=203 \]
I tillegg er
\[ \text{plasser flyttet i dividend}-\text{plasser flyttet i divisor}=2-5=-3 \]
Vi flytter komma 3 plasser til \textsl{høyre} i 203. Da får vi 203\,000. Altså er
\[ 4,06:0,00002=203\,000 \]
}
...
\eks[1]{
	...
	\metode{Utregningsmetode 1}{0.35\linewidth}
	\os
	\begin{tabular}{r|r|r}
	...
	\metode{Utregningsmetode 2}{0.35\linewidth}\os
	\begin{tabular}{r|r|r}
		& & 10:45 \\ \hline 
		00:15 & 00:15 & 11:00 \\
		00:10 & 00:25 & 11:10 \\
...
\eks[2]{
	...
	\begin{center}
		\parbox{0.4\linewidth}{
			\metode{Utregningsmetode 1}{0.9\linewidth} \os
			\begin{tabular}{r|r}
				&  9\enh{t} 34\enh{min} \\ \hline 
				26\enh{min} & 10\enh{t} 00\enh{min} \\
				18\enh{min} & 10\enh{t} 18\enh{min} \\
				4\enh{t} & 14\enh{t} 18\enh{min} \\ \hline
				4\enh{t} 44\enh{min}
			\end{tabular}
		} \qquad \qquad
		\parbox{0.4\linewidth}{
			\metode{Utregningsmetode 2}{0.9\linewidth} \os
			\begin{tabular}{r|r}
				& 09:34 \\ \hline 
				00:26 & 10:00 \\
				00:18& 10:18 \\
...
Ved \outl{avrunding} endrer vi verdien til tall, helst for at de skal bli\\ lettere å lese eller å bruke i utregninger. En vanlig form for avrunding er å avrunde til \textsl{nærmeste ener}, \textsl{nærmeste tier} og lignende.\regv
\info{Avrunding til nærmeste tier}{
...
\[ 98,2+24,6 \]
Vi ser at $ 98,2 \approx 100 $. Skriver vi 100 i steden for 98,2 i regnestykket vårt, får vi noe som er litt mer enn det nøyaktige svaret. Skal vi endre på 24,6 bør vi derfor gjøre det til et tall som er litt mindre. 24,6 er ganske nærme 20, så vi kan skrive
\[ 98,2+24,6 \approx 100 + 20 = 120 \]
Når vi gjør overslag på to tall som legges sammen, bør vi altså prøve å gjøre det éne tallet større (runde opp) og det andre tallet mindre (runde ned).\\
\newpage
\linje
Det samme gjelder også hvis vi har ganging. La osss gjøre et overslag på
\[ 1\,689\cdot12 \]
Her avrunder vi 12 til 10. For å ''veie opp'' for at svaret da blir litt mindre enn det egentlige, runder vi 1\,689 ned til 1\,700. Da får vi
\[ 1\,689\cdot12\approx 1\,700\cdot 10 =17\,000 \]
\subsubsection{Overslag ved subtraksjon og deling}
Skal et tall trekkes fra et annet, blir det litt annerledes. La oss gjøre et overslag på
\[ 186,4-28,9 \]
Hvis vi runder 186,4 opp til 190 får vi et svar som er større enn det egentlige, derfor bør vi også trekke fra noe. Det kan vi gjøre ved også å runde 28,9 oppover (til 30):
\alg{
	186,4-28,9&\approx 190-30 \\&=160
}
\linje
Samme prinsippet gjelder for deling. La oss gjøre et overslag på
\[ 264:17 \]
Vi runder 17 opp til 20. Deler vi noe med 20 i steden for 17, blir svaret mindre. Derfor bør vi også runde 264 oppover (til 300):
\[ 294:17 \approx 300:20 = 15 \]

\newpage
\subsubsection{Overslagsregning oppsummert}
\reg[Overslagsregning \label{tipsoverslag}]{ \vs
	\begin{itemize}
		\item Ved addisjon eller multiplikasjon mellom to tall, rund gjerne ett tall opp og ett tall ned.
		\item Ved subtraksjon eller deling mellom to tall, rund gjerne begge tall ned eller begge tall opp.
	\end{itemize}	
}
\eks[]{
...
\info{Tips}{
	...
	\begin{enumerate}
		\item Flytt komma slik at du får et tall som ligger mellom 0 og 10 (men er ikke lik hverken 0 eller 10).
		\item Gang dette tallet med en tierpotens som har eksponent med tallverdi lik antallet plasser du flyttet komma. \qquad  Flyttet du komma mot venstre/høyre, er eksponenten positiv/negativ. 
	\end{enumerate}
}
\eks[3]{
	...
	\sv \vs
	\begin{enumerate}
		\item 	Vi flytter komma 6 plasser til venstre, og får $ 9{\color{black},}761432 $
...
\eks[4]{
	...
	\sv \vs
	\begin{enumerate}
		\item Vi flytter komma 4 plasser til høyre, og får $ 3,9 $.
