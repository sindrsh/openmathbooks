...
Flytter vi komma tre plasser til høyre, får vi $42900,=42900$.
\fig{komma2}
}
\newpage
\eks[3]{
...
Flytter vi komma seks plasser til høyre, får vi $0001000,=1000$
\fig{komma4}
}
\eks[4]{
Gitt tallet $8,4$.\os
...
Flytter vi komma fire plasser til høyre, får vi $1090000$.
\fig{komma6}
}
\spr{Som nevnt, brukes punktum som desimaltegn i programmeringsspråk. Mange programmeringsspråk godtar at man skriver punktum helst til venstre i et tall. For eksempel kan man skrive $\sym{\texttt{0.1}}$ som \sym{\texttt{.1}}.\vsk
