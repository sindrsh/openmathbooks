...
\spr{Som nevnt, brukes punktum som desimaltegn i programmerings-språk. Mange programmeringsspråk godtar at man skriver punktum helt til venstre i et tall. For eksempel kan man skrive $\sym{\texttt{0.1}}$ som \sym{\texttt{.1}}.\vsk
	
Mange programmeringsspråk godtar også at man skriver \\ punktum helt til høyre i et tall, men da vil det ofte bety om tallet skal leses som et heltall eller ikke. For eksempel kan \sym{\texttt{1}} tolkes som et heltall, mens \sym{\texttt{1.}} kan tolkes som et desimaltall. I programmering kan det være forskjell på et heltall og et desimaltall selv om de har lik verdi.
}
...
\eks[3]{ \vsb
	...
	38{\color{black},}02\cdot10\,000&=380200{\color{black},}=380\,200 \vn
...
\[ 98,2+24,6 \]
Vi ser at $ 98,2 \approx 100 $. Skriver vi 100 i stedet for 98,2 i regnestykket vårt, får vi noe som er litt mer enn det nøyaktige svaret. Skal vi endre på 24,6 bør vi derfor gjøre det til et tall som er litt mindre. 24,6 er ganske nærme 20, så vi kan skrive
...
\[ 264:17 \]
Vi runder 17 opp til 20. Deler vi noe med 20 i stedet for 17, blir svaret mindre. Derfor bør vi også runde 264 oppover (til 300):
...
\info{Tips}{
	...
	\begin{enumerate}
		\item Flytt komma slik at du får et tall som er større enn 0 og mindre enn 10.
