...
gang(6,A=(3.5,1.5),nn=3);
label("$0\cdot6=\phantom{0}0$",shift(3.5,1.5)*(0,0),fontsize(9pt),align=W);
...
label("\color{blue}1",sh*(3dx,5dy));
label("\color{blue}8",sh*(5dx,5dy));
label("\color{heavygreen}3",sh*(17dx,0));
/*
