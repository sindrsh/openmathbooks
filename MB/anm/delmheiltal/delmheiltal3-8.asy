...
gang(6,A=(3.5,1.5));
label("${\color{blue}0}\cdot6=\color{heavygreen}\phantom{0}0$",shift(3.5,1.5)*(0,0),fontsize(9pt),align=W);
...
label("\color{cyan}1",sh*(3dx,2dy));


label("\color{blue}0",sh*(3dx,3dy));
label("\color{heavygreen}0",sh*(15dx,0));
/*
