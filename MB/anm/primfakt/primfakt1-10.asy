...
label("$84=\color{blue}2\cdot2\cdot3\cdot7$",(0,1.5),E);
...
label("$\color{blue}2$",sh*(b+dx,y-dy),2W);
label("$\color{black}42$",sh*(b+2dx,y-dy),W);

label("$\color{black}42$",sh*(b,y-2dy),W);
label("$\color{blue}2$",sh*(b+dx,y-2dy),2W);
label("$\color{black}21$",sh*(b+2dx,y-2dy),W);

label("$\color{black}21$",sh*(b,y-3dy),W);
label("$\color{blue}3$",sh*(b+dx,y-3dy),2W);
label("$\color{blue}7$",sh*(b+2dx,y-3dy),W);
