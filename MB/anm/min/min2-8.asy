...
label("\color{blue}0,3",(s-dx,y-dy),W);
label("\color{blue}0,6",(s-dx,y-2dy),W);
label("\color{blue}6\phantom{,0}",(s-dx,y-3dy),W);
label("\color{blue}4\phantom{,0}",(s-dx,y-4dy),W);
label("\color{blue}100\phantom{,0}",(s-dx,y-5dy),W);
