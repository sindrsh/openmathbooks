...
label("$40$",sh*(b,y-dy),W,pp1);
label("$120$",sh*(b+dx,y-dy),W,pp2);
/*
label("$120$",sh*(b+2dx,y-dy),W,pp2);

label("$2$",sh*(b,y-2dy),W,pp1);
label("$6$",sh*(b+dx,y-2dy),W,pp0);
label("$126$",sh*(b+2dx,y-2dy),W,pp1);
