...
label("$30$",sh*(b,y-dy),W,pp1);
label("$90$",sh*(b+dx,y-dy),W,pp0);
label("$90$",sh*(b+2dx,y-dy),W,pp0);


label("$10$",sh*(b,y-2dy),W,pp1);
label("$30$",sh*(b+dx,y-2dy),W,pp0);
label("$120$",sh*(b+2dx,y-2dy),W,pp1);

label("$2$",sh*(b,y-3dy),W,pp1);
label("$6$",sh*(b+dx,y-3dy),W,pp0);

label("$126$",sh*(b+2dx,y-3dy),W,pp0);

draw(shift(0,y-3.5dy)*sh*p1);
label("$42$",sh*(b,y-4dy),W,pp2);
