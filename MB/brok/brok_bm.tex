...
\amounts{\fig{br7a}}
\numrline{\fig{br7ta}}
Det vi har gjort, er å utvide begge brøkene slik at de har samme nevner, nemlig 10. Når nevnerne i brøkene er like, kan vi regne ut differansen mellom tellerne:
...
\[ 4=\dfrac{12}{3} \]
\fig{br10c4}
Husk nå at en tolkning av $ 4:\frac{2}{3} $ er
\begin{center}
...
\end{center}
For å finne dette tallet starter vi med å gange $ \frac{2}{3} $ med tallet som gjør at produktet blir 1. Dette er \outl{den omvendte brøken}\index{brøk!omvendt} av $ \frac{2}{3} $, som er $ \frac{3}{2} $:
...
\eks[3]{
	Skriv om det blandete tallet $ 3+\frac{4}{5} $ til en brøk.
