...
La oss se på brøken $ \frac{1}{4} $ som en mengde. Vi starter da med å tenke på tallet 1 som en rute\footnote{Her har vi valgt en enerrute som er større enn den vi brukte i \refkap{Talavare}.}: 
\begin{figure}[hbt]
	\centering
...
Brøker kan ha lik verdi selv om de ser forskjellige ut. Hvis du regner ut $ 1:2 $, $ 2:4 $ og $ 4:8 $, får du i alle tilfeller 0,5 som svar. Dette betyr at
\alg{
...
En brøk som $ \frac{6}{10} $ kan vi gjøre om til en brøk med 5 i nevner ved å dele både teller og nevner med 2:
...
\eks[2]{
	...
	\sv
	Da $ {50\cdot2=100} $, utvider vi brøken med 2:
	\[ \frac{150}{50} = \frac{150\cdot2}{50\cdot2} = \frac{300}{100} \]
...
\eks[3]{
	...
	\sv
	Da $ 30:6=5 $, forkorten vi brøken med 6:
...
La oss se på regnestykket\footnote{Vi minner om at rødfargen på pila viser at man skal vandre fra pilspissen til andre enden.}
\[ \frac{3}{5}-\frac{1}{2} \]
\amounts{\fig{br7}}
\numrline{\fig{br7t}}
...
\[ \frac{6}{8}:2 \]
\amounts{\fig{br15} \vs}
\numrline{\fig{br15t} \vs}
Vi har her 6 åttedeler som vi skal fordele likt på 2 grupper. $ 6:2=3 $, altså er
\[ \frac{6}{8}:2=\frac{3}{8} \]
\amounts{\fig{br15a}}
...
\numrline{\fig{br5ct}}
\newpage
Nå har vi 6 åttedeler. 6 åttedeler delt på 2 er 3 åttedeler:
\[ \frac{3}{4}:2=\frac{3}{8} \]
\amounts{\fig{br5a}}
\numrline{\fig{br5at}}
%\fig{br5b}
...
De to svarene har altså lik verdi. Skal vi dele en brøk på et heltall, og telleren er delelig med heltallet, kan vi direkte dele telleren på heltallet. I slike tilfeller er det altså ikke \textsl{feil}, men heller \textsl{ikke nødvendig} å bruke \rref{brdeenk}.
}
...
Når bare ganging er til stede i brøker, kan man alltid omrokkere slik vi har gjort over, men når man har forstått hva omrokkeringen ender med, er det bedre å bruke \outl{kansellering}\index{kansellering}. Man setter da en strek over to og to like faktorer for å vise at de utgjør en brøk med verdien 1. Tilfellet vi akkurat så på skriver vi da som 
...
\info{Brøker forenkler utregninger}{
	Desmialtallet $ 0,125 $ kan vi skrive som brøken $ \frac{1}{8} $. Et regnestykke som ${0,125\cdot16}$ kan vi da forenkle slik:
	\alg{
