...
\eks[1]{\vsb
	\algv{
			3:\frac{\color{c1}2}{\color{c2}9}&=3\cdot\frac{\color{c2}9}{\color{c1}2}\\
		&=\frac{27}{2}
	}
}
\eks[2]{\vsb
...
\info{\note}{
	In a lot of texts you will find numbers like those from \textsl{Example 1} written like this:
	\[   2\dfrac{5}{7} \qquad\qquad
	8\dfrac{2}{7} \qquad\qquad
	4\dfrac{1}{10}  \]
}
...
\eks[2]{
	...
	\sv 
	We observe that 17 is the numerator and 3 the denominator. The largest number we can multiply by 3 without getting a product larger than 17 is 5, so
	\alg{
...
\eks[3]{
	...
	We have $ 3=\frac{3}{1} $, so
	\[ 3+\frac{4}{5}=\frac{3}{1}+\frac{4}{5} \]
	Moreover\footnote{See \rref{braduliknemn}.},
	\alg{
