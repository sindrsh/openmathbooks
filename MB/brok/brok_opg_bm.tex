...
Forkort\os
\abch{
	\item $ \frac{14}{26} $ med 2.	
	\item $ \frac{15}{12} $ med 3.
	\item $ \frac{20}{16} $ med 4.
} \vsk

\abchs{3}{
	\item $ \frac{35}{50} $ med 5.
	\item $ \frac{54}{18} $ med 6.
	\item $ \frac{49}{63} $ med 7.
}
...
\abc{
	...
	\item $ \frac{18}{63} $ til en brøk med 7 som nevner.
}
\newpage
\op{opgbrsjekk}
Undersøk om brøkene har lik eller ulik verdi.\os
\abch{
\item $\frac{4}{3}$ og $\frac{6}{5}$
\item $\frac{20}{50}$ og $\frac{2}{5}$
\item $\frac{7}{3}$ og $\frac{9}{5}$
}
...
\op{opgheildelbrfork}
Regn ut, og forkort brøken så mye som mulig. \os
\abch{
	\item $ 4:\dfrac{8}{9} $
	\item $ 7:\dfrac{21}{5} $
	\item $ 10:\dfrac{5}{3} $
