...
Utvid
\abc{
	\item $ \frac{7}{3} $ til ein brøk med 15 som nevner.
	\item $ \frac{3}{4} $ til ein brøk med 32 som nevner.
	\item $ \frac{10}{9} $ til ein brøk med 63 som nevner.
}
...
Utnytt at nevneren er ein faktor i talet det blir gonga med, og rekn ut\os
\abch{
...
\mers{Her har vi valgt å primtalsfaktorisere alle tallene, men man trenger ikke gjøre det hvis mans ser hvilke faktorer som er felles for tellerene og nevnerene.}
} \regv

Utnytt at tellerene og nevnerene har felles faktorer, og regn ut. \os
\abch{
