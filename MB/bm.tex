...
\newcommand{\refop}[1]{{\color{NavyBlue}Oppgave \ref{#1}}}
\newcommand{\refops}[1]{{\color{NavyBlue}oppgave \ref{#1}}}
\newcommand{\refgrub}[1]{\vspace{3pt}\textbf{\color{NavyBlue} gruble \ref{#1}}}

\newcommand{\amounts}[1]{
	\begin{tcolorbox}[boxrule=0.3 mm,arc=0mm,colback=white]  #1  \vs
		\small \rightline{Mengde}
	\end{tcolorbox}
}
\newcommand{\numrline}[1]{
	\begin{tcolorbox}[boxrule=0.3 mm,arc=0mm,colback=white]  #1  \vs
		\small \rightline{Tallinje}
	\end{tcolorbox}
}
...
\newcommand{\Rasjtal}{Rasjonale og irrasjonale tall}
...
\newcommand{\grside}{Størst side, størst vinkel (og omvendt)}
...
\newcommand{\geofork}{Forklaringer}
\newcommand{\pytomv}{\pyt\, (omvendt)}
...
\newcommand{\brdef}{Brøk som omskriving av divisjonsstykke}
...
\newcommand{\gangparsam}{Parenteser ganget sammen}
...
\newcommand{\corra}{Samsvarende vinkler}
