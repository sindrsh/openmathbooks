...
Det er vanlig å utelate gangetegnet når et tall ganges med en parentesuttrykk. Altså er for eksempel ${2(3-1)}$ det samme som $2\cdot(3-1)$. 
}
\newpage
...
I uttrykk som bare inneholder divisjon og multiplikasjon kan vi flytte på divisorer og faktorer uten at verdien endres. For eksempel ak vi skrive uttrykket $3:8\cdot16$ kan vi skrive som $3\cdot16:8$
}
...
\regdef[Faktorisering]{\index{faktorisering}
	\outl{Faktorisering} er å skrive et tall som et produkt av andre tall.
}
\eks{
