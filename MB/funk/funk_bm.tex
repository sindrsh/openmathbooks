...
Som vi har vært inne på før, kan vi aldri tegne en hel linje, bare et utklipp av den. Dette gjelder som regel også for grafer. I figuren på side \pageref{funkfig} har vi tegnet grafen til $ f(x) $ for $ x $-verdier mellom $ -2 $ og $ 4 $. At $ x $ er i dette \outl{intervallet}\index{intervall} kan vi skrive som $ -2\leq x\leq 4 $ eller\footnote{Se \tmen for en nøyere forklaring av denne skrivemåten.} $ x\in[-2, 4] $.
