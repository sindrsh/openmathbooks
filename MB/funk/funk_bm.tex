...
\info{$\bm {f(x)}$ og $\bm f$}{
Når vi omtaler en funksjon $f(x)$, nøyer vi oss ofte med å skrive bare $f$. Istedenfor å skrive for eksempel ${f(x)=2x}$, kunne vi også skrevet $f=x$, men det fine med førstnevnte skrivemåte er at det tydeliggjør at det er $x$ som er variabelen.
}
