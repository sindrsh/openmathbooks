...
\begin{tcolorbox}[boxrule=0.3 mm,arc=0mm,colback=blue!5] {\large \textbf{Kongruens} \vspace{5 pt}}\newline
	To trekanter $ \triangle ABC $ og $ \triangle DEF $ er kongruente hvis ett av følgende vilkår er oppfylt:
	\begin{enumerate}[label=\roman*)]
		\item $ AB=DE $, $ BC=EF $ og $ \angle A=\angle D $.
		\item $ \angle A=\angle D $, $ \angle B=\angle E $ og $ AB=DE $.
		\item $ AB=DE $, $ BC=EF $ og $ AC=DF $.
		\item $ {\angle A=\angle D} $ og $ {\angle B=\angle E} $, i tillegg er $ {AB=DE} $ eller $ BC=EF $ eller $ AC=DF $.
	\end{enumerate}
	\fig{geo14k} \vs
...
\newpage
I tekstboksen på forrige side gir også vilkår (i)\,-\,(iii) tilstrekkelig informasjon om når en trekant kan bli unikt konstruert, men i denne boka har vi valgt å skille unik konstruksjon og kongruens fra hverandre. Dette er gjort i den tro om at de fleste vil ha en intuitiv tanke om hvilke trekanter som er kongruente eller ikke, men ha større problem med å svare på hva som må til for å unikt konstruere en trekant $ - $ \\og det er ikke nødvendigvis så lett å se dette direkte ut fra kongruensvilkårene.\vsk
