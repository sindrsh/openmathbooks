...
\info{En ny tolkning av 0}{
	Innledningsvis i denne boka nevnte vi at 0 kan tolkes som \\''ingenting''. Subtraksjon gir oss muligheten til å uttrykke 0 ved andre tall. For eksempel er 
	%id{7min7}
	$ {7-7=0} $ 
	%\id
	og 
...
%id{arrow}
\footnote{I figurer med tallinjer vil rødfargede piler fortelle at man starter ved pilspissen og vandrer til andre enden.}:
%\id
 \regv
\info{Merk}{
