...
\info{Merk}{
	De kommende sidene vil inneholde regler for potenser med tilhørende forklaringer. Selv om det er ønskelig at forklaringer har en så generell form som mulig, har vi i utledningene valgt å bruke eksempler der eksponentene ikke er variabler. Å bruke variabler som eksponenter ville gitt mye mindre leservennlige uttrykk, og vi vil påstå at de generelle tilfellene kommer godt til syne også ved de konkrete tilfellene. 
} \vsk 
