...
Verdien til tallene som er representert ved bokstaver vil ofte variere ut ifra en sammenheng. Da kaller vi disse bokstavtallene for \outl{variabler}\index{variabel}. Hvis bokstavtallene derimot har en bestemt verdi, kaller vi dem for \outl{konstanter}\index{konstant}.
