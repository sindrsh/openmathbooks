...
\newpage
\grubop{opgalgsquare}
I begge figurene under er et kvadrat delt inn i mindre rektangler og kvadrater. Arealene til de fargede kvadratene er vist i figurene. I \textsl{Figur (b)} har det største kvadratet sidelengde $a$.
\abc{
...
\abc{
\item $\displaystyle \frac{9^{\frac{1}{2}}\cdot 3^{-1}+9^0}{8^{\frac{3}{4}}}$
