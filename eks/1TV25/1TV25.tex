...
\end{figure}
Altså er $x^2-4x-12<0$ for $x\in(-2, 6)$. \vsk

\textbf{Alternativ 2}\\
Da uttrykket er et andregradsuttrykk med positivt andregradsledd, vet vi at uttrykket er konvekst. Minimumspunktet ligger da midt mellom nullpunktene, altså har $f$ bunnpunkt for $x=\frac{-2+6}{2}=2$. $f(2)=(2+2)(2-6)=-16$. En andregradsfunskjon har likt fortegn på hver side av nullpunktene, og likt fortegn mellom nullpunktene. Mellom nullpunktene har $f$ samme fortegn som i bunnpunktet. Av dette vet vi at $f$  er negativ mellom nullpunktene. Altså er $x^2-4x-12<0$ for $x\in(-2, 6)$.
