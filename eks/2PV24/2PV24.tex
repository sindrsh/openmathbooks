...
\subsection*{Oppgave 2}
\abc{
\item I gjennomsnitt har Solveig brukt ca. 1,5 time mer på hver tur enn Miriam. Medianene forteller at halvparten av turene til Miriam har hatt en varighet på 4 timer eller mer, mens halvparten av turene til Solveig har hatt en varighet på 7,5 timer eller mer. At standardavviket til Miriam er større enn Solveigs, antyder at det har vært større variasjon i varigheten på turene til Miriam enn på turene til Solveig.
\begin{center}
...
\subsection*{Oppgave 4}
\abc{
\item I begge ligningene har Sara isolert $y$ på én side, og definert de to uttrykkene som henholdsvis $f$ og $g$. I for-løkken sjekker hun om det for heltalls $x$ mellom $-4$ og $5$ er noen skjæringspunkt mellom $f$ og $g$. Skjæringspunkt er løsninger av ligningssystemet. Hun finner punktene $(-3, 0)$ og $(2, 20)$.
