...
Den prosentvise fremgangen for henholdsvis Arbeiderpartiet og Senterpartiet er gitt ved brøkene $\frac{5}{40}$ og $\frac{5}{20}$. Da $\frac{5}{20}>\frac{5}{40}$, har Senterpartiet hatt størst fremgang.

\subsection*{Oppgave 3}
Viss $n$ personer skal fordele 100\enh{kr} likt mellom seg, vil prisen per person $100$ være gitt som
\[ p=\frac{100}{n} \] 
...
Det blir 5\,370\,000\,700\,000 blodceller til sammen.
...
\[ \text{Kvadrat i figur $n$}=n+1+n+n^2=n(2+n)+1 \]
}
...
Altså er 
\[ g(x)=12x+30 \]
\item Det er rimelig å anta at godterien har en fast hektopris, og at bøtta har en fast pris. Koster godteriet 12\enh{kr/hg} og bøtta koster 30\enh{kr}.
\item 
...
\item Bruker kommandoen \texttt{Linje}, og får en linje med stigningstall $70,24$. Dette betyr at den gjennomsnittlige økningen av antall smittede mellom $x=4$ og $x=21$ er lik $70,24$.
\item Mai i 2025 tilsvarer $x=29$. Bruker kommandoen \texttt{K(29)}, og får at det da vil være $5336$ tilfeller.
\begin{figure}
...
Hvis Elise tror hun vil greie å selge 21 eller flere aviser bør hun altså velge Tilbud 2. Hvis ikke bør hun velge Tilbud 1.
\begin{figure}
...
\textbf{Furu 28x095}\\
$\frac{49,9}{0,095}\approx1109$. Prisen per kvadratmeter er ca. 1109\enh{kr}.
...
\item Av grafen ser vi at bunnpunktet ligger mellom $r=0$ og $r=10$. Bruker kommandoen \texttt{Ekstremalpunkt}, og finner at $O$ er minst når $r=5,23$. Da er $O\approx258$.
}
\begin{figure}
