...
\info{Navnevalg}{
	...
	Hvis en ball har konstant fart og faller 40 meter på 2 sekunder, er farten 20\enh{m/s}. Vi har også sett i \am\ at en antatt konstant fart kalles \outl{gjennomsnittsfarten}. \os 
	
	Den \outl{gjennomsnittlige vekstfarten} er altså størrelsen vi får dersom vi antar at funksjonen (i nevnte tilfelle $ h $) og variabelen (i nevnte tilfelle $ t $) er proporsjonale størrelser.
}
\subsubsection{Momentan vekstfart}
I de fleste sitasjoner
\newpage	
