...
void f0(){ label("$128.4+97.8$", sh*M);  }

void f1(){ label("$97.3+20.7$", sh*M);  }

void f2(){ label("$32.3+85.6$", sh*M);  }

void f3(){ label("$45.3-4.8$", sh*M);  }

void f4(){ label("$43.1-25.9$", sh*M);  }

void f5(){ label("$87.5-65.4$", sh*M);  }

void f6(){ label("$765.2-746.5$", sh*M);  }
