...
I eit datasett er det gjerne svar som er heilt eller tilnærma like, og som gjentar seg. Dette betyr at vi kan seie noko om hva som gjelder for mange; ein \outl{tendens}. Dei matematiske omgrepa som fortel noko om dette kallast \outl{sentralmål}. Dei vanlegaste sentralmåla er \textit{typetal}, \outl{gjennnomsnitt} og \textit{median}. \vsk

\newpage
\subsection{Typetal}
\reg[Typetal]{
\outl{Typetalet} er verdien det er flest eksemplar av i datasettet.
} \regv
\st{
\textbf{Undersøking 2} \os
...
\info{Fleire typetal}{
	Hvis fleire verdiar opptrer oftast i eit datasett, har datasettet fleire typetal.
}
