...
Statistikk handler grovt sett om to ting;  \textsl{å presentere} og \textsl{å tolke} innsamlet data. For begge disse formålene har vi noen begrep som vi i kommende seksjoner skal studere ved hjelp av forskjellige eksempler på undersøkelser. Disse eksemplene finner du på side \pageref{undersok}. \vsk
