...
\info{Merk}{
I denne seksjonen er det bare gitt eksempler, og ingen regler. Det er fordi vi bruker regler vi har sett på i kapitlene om ligninger og funksjoner i \mb. Forskjellen er bare at vi her ser på størrelser med benevning.
}
\vsk
\eks[1]{
...
\eks[3]{En vennegjeng ønsker å spleise på en bil som koster 50\,000 kr, men det er usikkert hvor mange personer som skal være med på å spleise.\os 
...
\eks[4]{
	...
	Busselskapene tilbyr altså samme pris hvis sportsklubben skal kjøre 200\enh{km}.
	%\fig{lig2}
}
