...
\eksop{R2V23}{r2v23d1opg2}
Gitt vektorene $\vec{u}=[1, 2, -1]$ og $\vec{v}=[-1, 1, -2]$. For planet $\alpha$ er $\alpha \parallel \vec{u}$ og $\alpha \parallel \vec{v}$, og punktet $P=(2, 0, 1)$ ligger i $\alpha$.
\abc{
...
\abc{
\item Finn arealet til pyramiden.
