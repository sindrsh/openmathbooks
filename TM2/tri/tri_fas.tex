...
\item $ x=\frac{1}{3}(\frac{\pi}{6}+2\pi n)\vee x= \frac{1}{3}(\frac{5\pi}{6}+2\pi n) $ \item $ x=\frac{\pi}{3}(3n+1)\vee x= \frac{\pi}{6}(6 n+1)$ 
...
\abch{
\item $ P = \frac{2\pi}{3} $ 
\item $ f_{maks}=9 $, $ f_{min}=-1 $ 
\item $ f $ har maksimum for $ x= \frac{1}{3}\left(2\pi n-\frac{\pi}{12}\right) $ og minimum for $ x=\frac{1}{3}(2\pi n-\frac{11\pi}{12}) $
}
...
\item $ P=4 $ 
\item $ (-1, 3) $ og $ (3, 3) $ 
\item  $ x=-\frac{7}{3} $, $ x=\frac{5}{3} $ og $ x=\frac{1}{3} $
}
