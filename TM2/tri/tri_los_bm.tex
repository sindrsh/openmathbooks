...
\grubr{opgtriomskriv}
 Det eneste vi må sørge for er å gjøre om cosinusuttrykket til et sinusuttrykk. Av \eqref{cossomsi} vet vi at
\alg{
...
\op{opgtrifinnmaks}
Fordi sinusuttrykket multipliseres med det positive tallet 2, må toppunktene være der hvor sinusuttrykket blir 1. Da er $ x $ gitt ved ligningen
\alg{
	kx + c &= \frac{\pi}{2}+2\pi n
}	
Vi får derfor at
...
\grubr{udir} \\
\fig{rad_lf}
Si at sirkelen brukt for å måle vinkelen i radianer \textsl{ikke} er enhetssirkelen. Si videre at buelengden mellom $AB$ og $AC$ langs enhetssirkelen er $l_u$. Siden sirkler er forholdet mellom radiene og samsvarende buelengder likt. Altså er
\begin{align*}
	\frac{l}{r}=\frac{l_u}{1} \br
	l_u=\frac{l}{r}
\end{align*}
Dette betyr at $v=l_u$, som betyr at $v$ beskriver en buelengde langs enhetssirkelen.

\grubr{opgtricos2}
Vi har at
\begin{flalign*}
	1+\cos(2x)&= 1+\cos(x+x) \\
	&= 1+\cos x\cos x-\sin x \sin x &&(\rref{trig}) \\
	&= 1+\cos^2 x-\sin^2 x \\
