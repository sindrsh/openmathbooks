...
\op{odpar}
\textbf{a)} Skriv opp de tre første partallene. Lag en rekursiv og en eksplisitt formel partall nr. $i$.\os
	
\textbf{b)} Skriv opp de tre første oddetallene. Lag en rekursiv og en eksplisitt formel for oddetall nr. $i$. 
...
Gitt rekken
\[ 3+6+12+24+... \]	
For hvilken $n$ er summen av rekken lik 93?
...
\item  For hvilken $ x $ er summen av rekka lik $ \frac{3}{2} $?
...
\newpage
\op{099er1}
\textbf{a)} Skriv desimaltallet 0.999... som en uendelig geometrisk rekke.\os

\textbf{b)} Forklar hvorfor rekken er konvergent og bruk dette til å finne summen av rekken. 
...
\grubop{opgfoliplusone}
Omskriv \eqref{arrekeq}, \eqref{ekspl}, \eqref{geofolgrek} og \eqref{geofolgeks} til formler som gir uttrykk for $a_{i+1}$ i steden for $a_i$. \vsk

\grubop{viseks3}
Bruk summen av en aritmetisk rekke til å vise at ligningen gitt i \hyperref[prodind]{\textsl{Eksempel 3}} på side \pageref{prodind} er sann.
...
\grubop{opgfol}
Desimaltallet 0.097097... er et desimaltall med repeterende desimalmønster. Desimalmønsteret har verdi 97 og 3 repeterende siffer.
\abc{
\item Skriv 0.097097... som en geometrisk rekke
\item Skriv 0.097097... uttrykt som en brøk.
...
\mers{En nesten indentisk oppgave er gitt i \mb, men der er den tenkt løst ved andre metoder enn her.}
...
\item Vis at $I$ kan skrives som en geometrisk rekke. \\
