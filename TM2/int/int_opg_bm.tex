...
\end{figure}
Forklar ut ifra en arealbetraktning hvorfor\[ \int\limits_a^b f \,dx=\int\limits_a^b g\,dx -(b-a)k  \]
...
\grubop{opgint2i}
\abc{
\item La $I=\int \frac{\ln x}{x}\,dx$ og $x>0$. Bruk delvis integrasjon til å vise at
\[ I=(\ln x)^2-I \]
\item Vis at 
