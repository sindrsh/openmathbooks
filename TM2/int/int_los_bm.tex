...
\grubr{opgarchi}
\abc{
\item Vi forventer at $p$ og $q$ inngår i uttrykket for $I$ siden disse avgjør plasseringen av $A$ og $B$. Så lenge formen til $f$ er lik, vil ikke det avgrensede området endres. Siden bare $a$ påvirker formen til $f$, må også $a$ inngå i uttrykket for $I$, men ikke $b$ og $c$.
\item 
Vi lar $g(x)$ være funksjonen som beskriver linja gjennom $AB$. Da er (se {\color{NavyBlue} gruble ??} i \tmen)
\begin{align*}
	g(x)&=(a(p+q)+b)(x-p)+f(p) \\
...
Dermed er
\begin{align}
	I &= \int_{p}^{q} g-f\,dx  \br
	&= \left[\frac{ax^2}{2}(p+q)-apqx-\frac{1}{3}ax^3\right]_p^q \br
	&= \frac{aq^2}{2}(p+q)-apq^2-\frac{1}{3}aq^3-\left(\frac{ap^2}{2}(p+q)-ap^2q-\frac{1}{3}ap^3\right) \br
	&=\frac{a}{2}(p+q)(q^2-p^2)-apq(q-p)-\frac{a}{3}(q^3-p^3) \br
	&=\frac{a}{2}(q-p)((p+q)^2-2pq)-\frac{a}{3}(q^3-p^3) \br
	&=\frac{a}{2}(q-p)(p^2+q^2)-\frac{a}{3}(q^3-p^3) \br
	&=\frac{a}{2}(q-p)(p^2+q^2)-\frac{a}{3}(q-p)(p^2+q^2+pq) \\
	&=\frac{a}{6}(q-p)(3p^2+q^2-2p^2-2q^2-2pq) \\
	&=\frac{a}{6}(q-p)^3
\end{align}
\item Siden $I=\frac{a}{6}(q-p)^3$ og $A_{\triangle ABC}=\frac{a}{8}(q-p)^3$, er 
\[ \frac{I}{A_{\triangle ABC}}=\frac{4}{3} \]
\item Vi har at
\begin{align*}
	A_\text{blått område}+A_{\triangle ABC}&=\frac{4}{3}A_{\triangle ABC} \\
	\frac{A_{\triangle ABC}}{A_\text{blått område}}&=3
\end{align*}
}
...
\grubr{r2v23d1opg8}
Grafene til $f$ og $g$ skjærer hverandre når $f=g$, altså når
\[ \cos(2x)=\frac{1}{2} \]
Da $\acos\left(\frac{1}{2}\right)=\frac{\pi}{3}
