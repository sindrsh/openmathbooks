...
\grubr{opgarchi}
\abc{
\item Vi forventer at $p$ og $q$ inngår i uttrykket for $I$ siden disse avgjør plasseringen av $A$ og $B$. Så lenge formen til $f$ er lik, vil ikke det avgrensede området endres. Siden bare $a$ påvirker formen til $f$, må også $a$ inngå i uttyrkket for $I$.
\item 
