...
\op{sincosoneminonesincos0}
\abc{
\item Vis at alle løsninger av ligningen $\cos x=1$ er gitt som $x=2\pi n $.
\item Vis at alle løsninger av ligningen $\cos x=-1$ er gitt som $x=\pi+2\pi n$.
\item Vis at alle løsninger av ligningen $\sin x=1$ er gitt som $x=\frac{\pi}{2}+2\pi n$.
\item Vis at alle løsninger av ligningen $\sin x=-1$ er gitt som $x=-\frac{\pi}{2}+2\pi n$.
\item Vis at alle løsninger av ligningen $ \cos x=0 $ er gitt som $x = \frac{\pi}{2}+\pi n$.
\item Vis at alle løsninger av ligningen $ \sin x = 0 $ er gitt som $x = \pi n$.
}
...
\os
Forklar hvorfor radianer ut ifra denne definisjonen også kan sees på som en buelengde langs enhetssirkelen. \vsk

\grubop{opgkvadtri}
Løs ligningen.
\abch{
\item $\cos^2 x -3 \cos x - 4=0$
\item $2\sin^2 x -3\sin x-2 \label{sin2}=0$
\item $4\cos^2 (\pi x) -\sqrt{48}\cos (\pi x) +  3=0$
}

\grubop{opgkvadtri2}
Løs ligningen.
\abc{
\item $3 \cos^2 (2x) + 5\sin^2 (2x) = 4$
\item $-3\cos^2(5 x)+\sin^2(5 x)=-2$
}
