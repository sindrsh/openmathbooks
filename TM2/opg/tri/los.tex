...
\grubr{opgkvadtri}
\abc{
\item Vi starter med å løse andregradsligningen mhp. $ \cos x $. Da $ 1(-4)=-4 $ og $ 1-4=-3 $, får vi at (se \refved{abc})
...
\[ x = \pi + 2\pi n \]
\item Vi observerer at (\ref{sin2}) er en andregradsligning for $ \sin x $ (erstatt $ \sin x $ med $ u $ hvis du syns det er vanskelig å se). Vi kan derfor bruke \textit{abc}-formelen til å løse ligningen med hensyn på $ \sin x $, og finner da at:
...
\[ x = \frac{\pi}{6}+2\pi n \quad \vee \quad x = \pi-\frac{\pi}{6}+2\pi n=\frac{5\pi}{6}+2\pi n\]
Derimot er det ingen \textit{reelle} tall som kan oppfylle ligningen \\ $ {\sin x=-2} $, vi anser derfor (\ref{sin2}) som ferdig løst.
\item Av $ abc $-formelen er
\alg{
...
Da $ 1 = \cos^2 (2x)+\sin^2 (2x) $, kan vi skrive
\alg{
	4 &= 4\cdot1 = 4\left(\cos^2 (2x)+\sin^2 (2x)\right)
}
Altså er
\alg{
...
\textbf{Alternativ 2} \\
Da $\sin^2(2x) = 1-\cos^2 (2x)$, kan vi skrive 
\alg{
3\cos^2 (2x)+5(1-\cos^2(2x))&=4 \\
-2\cos^2(2x)&=-1 \\
\cos^2(2x)&=\frac{1}{2} \\
\cos(2x)&=\pm \frac{1}{\sqrt{2}} \\
\cos(2x)&=\pm \frac{\sqrt{2}}{2}
}
Da $\acos\left(\pm \frac{\sqrt{2}}{2}\right)=\pm \frac{\pi}{4}$, har vi at
\alg{
...
Siden $\cos^2(2x)=\frac{1}{2}\cos(4x)+\frac{1}{2}$ (se \opr{cos2xopg}), har vi at
\alg{
-\cos(4x)-1&=-1 \\
\cos(4x)&=0
}
Da $\acos(0)=\frac{\pi}{2}$, er
\alg{
4x&=\frac{\pi}{2}+\pi n \br
...
\textbf{Alternativ 2}
\alg{
-3\cos^2x(5x)+1-\cos^2(5x)&=-2 \\
4\cos^2(5x)&=3 \\
\cos(5x)&=\pm \frac{\sqrt{3}}{2}
}
Siden $\acos\left(\pm \frac{\sqrt{3}}{2}\right)=\pm\frac{\pi}{6}$, er
\alg{
5x&=\pm \frac{1}{6}+2\pi n \\
x &=\frac{1}{5}\left(\pm \frac{1}{6}+2\pi n\right)
}
}
