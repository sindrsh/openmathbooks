...
The \textit{Consumer price index} (CPI) is an index indicating a comparative price level of urban merchandise and services, such as\vs
...
As mentioned, a ''kroneis'' cost 0.75\enh{kr} in 1953, and 27\enh{kr} in 2021. When at two distinct points of time we have to pay a \textsl{different} price for the \textsl{same} merchandise it will often mean that the \outl{krone value} has changed;\textsl{ 1\enh{kr} in 1957 was more worth than 1\enh{kr} i 2021.
}\vsk
