...
\op{opgfrkvtb2}
Lag en frekvenstabell for datasettet fra \refops{statsentrpar2}. (La tittelen til venstre kolonne være ''tall''.)

\op{opgstatsoyl} \vs
\abc{
\item Lag et søylediagram for datasettet fra \refops{frkvtb1}.
\item Lag et søylediagram for datasettet fra \refops{frkvtb2}.
}
...
Prøv metoden på datasettet fra \refops{statsentrpar1}.
