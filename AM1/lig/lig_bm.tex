...
\section{Endringen mellom to punkt}
Se for deg at vi slipper en ball fra 45 meter over bakken, og lar den falle fritt nedover. Når vi slipper ballen, starter vi også en stoppeklokke. Antall meter $ h $ ballen er over bakken etter $ t $ sekunder kan da tilnærmes ved funksjonen
\[ h(t)=50-5t^2 \]
\fig{ball}
...
\[ h(0)=50\qquad,\qquad h(1)=50-5\cdot1^2=45 \]
Dette betyr at i løpet av det første sekundet har ballen bevegd seg $ {50-45=5} $ meter nedover. Hvis farten var konstant ville den derfor vært
\[ \frac{5\enh{m}}{1\enh{s}}=5\enh{m/s} \]
Videre har vi at
\[ h(3)=50-5\cdot3^2 =5  \]
Dette betyr at mellom $ {t=1} $ og $ {t=3} $ har ballen gått fra å være 45 meter over bakken til 5 meter over bakken. Altså har ballen bevegd seg $ {45-5=40} $ meter i løpet av $ {3-1=2} $ sekunder. Hvis farten var konstant ville den derfor vært
