...
I \mb\;(s. 35\,-\,47) har vi sett hvordan brøker er definert ut ifra en inn-\\deling av 1. I hverdagen bruker vi også brøker for å snakke om inndelinger av en helhet: \vs
\begin{figure}
	\centering
...
\begin{center}
	\begin{enumerate}[label=({\alph*})]
		...
		\item Helheten er et kvadrat. Det ene hjørnet til trekanten ligger på midtpunktet til kvadratet. $ \frac{1}{4} $ av kvadratet er rødt.
...
Alle brøker har en verdi, og alle verdier kan vi skrive om til en brøk med 100 i nevner. For eksempel er ${89800=\frac{890}{100}}$ og ${0,125=\frac{12,5}{100}}$ (forklar for deg selv hvorfor!). Dette kan vi utnytte for å skrive om brøker til prosenttall.
}
\eks[5]{
Gjør om brøkene til prosenttall.\os
\abch{
...
\item $\dfrac{1}{5000}=0,0002=\dfrac{0,02}{100}=0,02\%$
}
}
\eks[6]{
	Finn 50\% av 800.
...
\info{Tips}{Å dele med 100 er såpass enkelt, at vi gjerne kan uttrykke prosenttall som desimaltall når vi gjør utregninger. I \textsl{Eksempel 6} over kunne vi har regnet slik:
\[ 2\% \text{ av } 7,4 = 0,02\cdot 7,4 =0,148 \]
}
\info{Promille}{
Noen ganger er det bedre å bruke brøker med 1000 i nevner for å oppgi andeler. Da brukes symbolet \sym{\textperthousand}, som uttales \textit{promille}.
