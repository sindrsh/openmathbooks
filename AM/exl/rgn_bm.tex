...
\begin{itemize}
	\item {\tt{=SUMMER}(celle1:celle2)} \\
	Summerer alle verdiene fra og med celle 1 til og med celle 2.
	\item {\tt{=MODUS}(celle1:cell2)} \\
	Finner typetallet for alle verdiene fra og med celle 1 til og med celle 2.\\
	\textit{Obs! Hvis datasettet har flere verdier som det er mest av, vil den minste verdien gis som typetallet.}
	\item {\tt{=GJENNOMSNITT}(celle1:celle2)} \\
	Finner gjennomsnittet for alle verdiene fra og med celle 1 til og med celle 2.
	\item {\tt{=MEDIAN}(celle1:celle2)} \\
	Finner medianen for alle verdiene fra og med celle 1 til og med celle 2. 
	\newpage
	\item {\tt{=VAR.P}(celle1:celle2)} \\
	Finner variansen for alle verdiene fra og med celle 1 til og med celle 2.
	\item {\tt{=STDEV.P(celle1:celle2)}} \\
	Finner standardavviket for alle verdiene fra og med celle 1 til og med celle 2.
\end{itemize}	
}
