...
Finn minst fem datasett som har følgende egenskaper:
\begin{itemize}
\item de består av fem positive heltall
...
\end{center}
\abc{
\item For jenter og gutter adskilt, og for klassen som helhet, finn (eventuelt) typetallet, medianen, gjennomsnittet, variasjonsbredden, variansen og standardavviket.
