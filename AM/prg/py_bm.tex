...
\newpage
Med funksjonen \texttt{pop()} kan vi hente et objekt fra listen. Når vi henter objektet blir det også fjernet fra listen.
\pythonut{list4.py}{
a = 19 \\
min\_liste = [6, 10, 15] \\
a = 10 \\
...
\newpage
Med funksjon \texttt{count()} kan vi telle gjentatte elementer i listen.
\pythonut{list6.py}{
4\\
1\\
2\\
...
Påstand: Alle programmerere vil erfare at skriptet ikke kjører fordi vi ikke har skrevet koden på rett måte. Dette kalles en \outl{error}. Ved error vil man få beskjed om på hvilken linje feilen befinner seg, og hva som er feil. De vanligste feilene er
\begin{itemize}
...
\subsubsection{Klassiske regnearter}
