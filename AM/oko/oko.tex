...
Innen økonomi er \outl{indekser}\index{indeks} forholdstall som forteller hvor mye størrelser har forandret seg. For eksempel kostet en krone-is ca 0,75\,kr (!) da den ble lansert i 1953, mens den i 2021 kostet ca 27\,kr. Forholdet mellom prisen i 2021 og i 1953 er da
...
\outl{Konsumprisindeksen}\index{konsumprisindeks} (KPI)\index{KPI} er en indeks som beskriver et sammenlignbart prisnivå på varer og tjenester som en typisk husstand i Norge bruker penger på i løpet av et år. Disse varene og tjenestene er \vs
...
\parbox[t]{0.49\linewidth}{\begin{itemize}
		...
		\item Elektrisitet
\end{itemize}}
For å sammenligne noe, må man alltid ha et utgangspunkt. Konsumprisindeksen tar utgangspunkt i prisnivået på de nevnte varene/tjenestene i det som er satt som \outl{basisår}\index{basisår}. 
\newpage
\reg[Basisår]{I et basisår er verdien til indeksen satt til 100.}
\info{Nye basisår}{
Hvilket år som er basisår forandrer seg med tiden. I denne boka bruker vi 2015 som basisår. Dette var basisåret satt av \outl{Statissk sentralbyrå} (SSB) i perioden 2017-2025. Før det var basisåret 1998. Fra og med 2026 bruker SSB 2025 som basisår.
}

Tabellen under viser samlet KPI i perioden 2011-2020:
\begin{center}
	\begin{tabular}{c|c}
		År &  KPI \\ \hline
		2020 & 112,2\\
		...
		2011&	93,3\\
	\end{tabular}
	\captionof{table}{Kunsumprisindeksen for årene 2011-2020, med 2015 som basisår. Tall hentet fra \net{https://www.ssb.no/priser-og-prisindekser/konsumpriser/statistikk/konsumprisindeksen}{SSB}. \label{KPI}}
\end{center}
Av tabellen kan vi for eksempel lese dette:
\begin{itemize}
	\item Da KPI for 2017 er 105,5\,, har prisene steget med 5,5\% siden 2015.
	\item Da KPI i 2011 er 93,3\,, var prisene 6,7\% lavere i 2011 enn i 2015.
\end{itemize}
\reg[Prosentvis endring fra basisår]{
...
\sv 
$ {98,0-100=-2} $. Prisen på sko er altså redusert med 2\% sammenlignet med basisåret.  
}
\subsection{Kroneverdi}
Vi har nevnt at en kroneis kostet 0,75 \,kr i 1953 og 27\,kr i 2021. Når vi ved to tidspunkt må betale \textsl{forskjellig} pris på den \textsl{samme} varen, skyldes det ofte at \outl{kroneverdien}\index{kroneverdi} har forandret seg;\textsl{ 1\enh{kr} i 1953 var mer verd  enn 1\enh{kr} i 2021.
}\vsk

Kroneverdien for et gitt år regnes ut fra KPI til basisåret (100): \regv
	
\reg[Kroneverdi \label{kroneverdi}]{
\[ \text{kroneverdi}=\frac{100}{\text{KPI}} \]
}
\info{Merk}{
Kroneverdien for basisåret (2015) er 1.
}
\eks[1]{
KPI i 2012 var 93,9. Regn ut kroneverdien i 2012, og gi en tolkning av svaret.

\sv 
\[ \text{kroneverdi i 2012} = \frac{100}{93,9}\approx 1,06 \]
Dette betyr at 1\,kr i 2012 tilsvarer 1,06\enh{kr} i basisåret 2015.
} \vsk

\info{Obs!}{
Ordet \textit{kroneverdi} brukes også når man sammenlikner verdien av 1\enh{kr} opp mot verdien av utenlandsk valuta. Kroneverdi ut fra et basisår og kroneverdi ut fra en valuta er ikke det samme.
}
...
Altså er
\alg{
\text{realverdien til 10\,000 i 1928}&= 10\,000\enh{kr}\cdot \frac{100}{3,2} \\
&= 312\,500 \enh{kr}
}
Videre er
\algv{
	\text{kroneverdi i 2020} &= \frac{100}{112,2}
}
Altså er
\alg{
	\text{realverdien til 350\,000 i 2020}&= 350\,000\cdot \frac{100}{112,2} \\
...
Hvor god \textsl{råd} vi har avhenger av hvor mye vi tjener og hva prisnivået er. Tenk at du  hadde en årslønn på 500\,000\,kr i både 2020 og i 2019. \hyperref[KPI]{\textsl{Tabell \ref*{KPI}}} forteller oss da at du hadde du best råd i 2019, fordi da var prisnivået (KPI) lavere enn i 2020. \vsk

At prisnivået har blitt høyere er det samme som at kroneverdien har blitt lavere. Dette betyr at hvis lønnen din var den samme i 2019 og 2020, er \textsl{realverdien} til lønnen din høyere i 2019 enn i 2020. Den opprinnelige lønnen og realverdien til lønnen er så mye brukt i statistikk at de har fått egne navn:\regv

\reg[Reallønn og nominell lønn\label{realnomonn}]{
\outl{Nominell lønn}\index{nominell lønn} er lønn  mottatt et gitt år. \vsk

\outl{Reallønnen}\index{reallønn} er realverdien til den nominelle lønnen. 	
}
\eks{
...
\sv
For å finne ut hvilket av årene Per hadde best råd i, sjekker vi hvilket år han hadde høyest reallønn\footnote{KPI-verdiene i utregningen henter vi fra \hyperref[KPI]{\textsl{Tabell 1}}.} (se \rref{realverdi}):
\alg{
...
\eks[1]{
	...
	\begin{center}
		...
		\end{tabular}
	\end{center}
I 2010 var KPI 92,1 og i 2020 var KPI 112,1.
...
Altså har prisen for sjokolade (tilnærmet) fulgt indeks, mens prisen for brus ikke har gjort det.
}

\section{Lån og sparing}
\subsection{Lån}
Noen ganger har vi  ikke nok penger til å kjøpe det vi ønsker oss, og må derfor ta opp et lån fra en bank. Banken gir oss da en viss \outl{lånesum}\index{lånesum} mot at vi betaler tilbake denne, og \outl{renter}\index{renter}, i løpet av en bestemt tid. Det vanligste er at vi underveis betaler banken det som kalles \outl{terminbeløp}\index{terminbeløp}, som på sin side består av \outl{avdrag}\index{avdrag} og renter. Pengebeløpet vi skylder banken kaller vi \outl{gjelden}\index{gjeld}. \vsk
...
\begin{itemize}
	\item \textbf{Summen av alle avdragene skal tilsvare lånesummen}.\\
	...
	\item \textbf{Det man betaler i avdrag skal trekkes fra gjelden.}\\
	...
	\item \textbf{Renter skal beregnes av gjelden.}\\
	...
	\item \textbf{Terminbeløpet er summen av avdraget og rentene}.\\
...
\end{itemize}\vsk
\textbf{Serielån og annuitetslån}\\
...
\textbf{Kredittkort}\\
Kredittkort er et betalingskort som er slik at hvis du f.eks. bruker kortet for å betale 10\,000\,kr, så låner du pengene fra banken. Etter en tid som er avtalt med banken vil den kreve renter av gjelden din. Til hvilken tid du betaler denne gjeldener delvis opp til deg selv, men generelt har kredittkort veldig høye renter, så det lureste er å betale før rentekravet har startet.
\regv
\reg[Lån]{
...
\abc{
\item Hva blir det årlige avdraget?
\item Hva er gjelden din etter at du har betalt tredje terminbeløp?
\item Hvor mye må du betale i renter ved fjerde terminbeløp?
\item Hvor stort blir det fjerde terminbeløpet?
}
...
\sv \vs
\abc{
\item Siden 300\,000\,kr skal betales over 5 år, blir det årlige avdraget
\[ \frac{300\,000\enh{kr}}{5}=60\,000\enh{kr} \]
\item Når tredje terminbeløp er betalt, har du betalt tre avdrag. Det betyr at gjelden din er
\alg{
...
\item Ut fra oppgave b) vet vi at gjelden er 120\,000 kr når fjerde terminbeløp skal betales. 3\,\% av gjelden blir da
\[ 120\,000\cdot0,03=3\,600 \]
Altså 3\,600 kr.\os
\item Terminbeløpet tilsvarer avdrag pluss renter. Ut fra oppgave a) og c) vet vi da at det fjerde terminbeløpet blir
\[ 60\,000\enh{kr}+3\,600\enh{kr} =63\,600\enh{kr}\]}
}
\newpage
\eks[2]{
Fra en bank låner du 100\,000\,kr med 6,4\,\% årlig rente. Lånet skal betales tilbake som et annuitetslån over 5 år, og banken har regnet ut at terminbeløpet blir 24\,000\enh{kr}.\os
...
Vi har sett at vi må betale renter når vi låner penger av en bank, men hvis vi i stedet setter penger (gjør et innskudd) i en bank  \textsl{får} vi renter:
\reg[Innskuddsrente]{
\outl{Innskuddsrente}\index{innskuddsrente} er en prosentvis økning av pengene du har i banken, gjentatt over faste tidsintervaller (månedlig, årlig o.l.) 
}
\eks[1]{
Du setter inn 20\,000\,kr i en bank som gir 2\% årlig sparerente. Hvor mye penger har du i banken etter 8 år? 

\sv
For å beregne innskuddsrenter kan vi anvende \rref{progjen}. Siden renten er 2\,\%, er vekstfaktoren 1,02. Originalverdien er 20\,000 og antall endringer (tiden) er 8. Dermed er
\[ \text{ny verdi}=20\,000\cdot1,02^8\approx 23\,433 \]
Du har altså ca. 23\,433\,kr i banken etter 8 år med sparing.
}
\subsubsection{Forventet avkastning}
En annen måte å spare penger på er å investere i et aksjefond. Da vil man snakke om \outl{forventet avkastning}\index{forventet avkastning}:\regv
\reg[Forventet avkastning]{
Forventet avkastning angir en \textsl{forventet} økning av en investering.
}
\newpage
\eks[1]{
Du investerer 15\,000 i et aksjefond som forventer 5\% årlig avkastning. Hvor mye er investeringen verd etter 8 år ved en slik avkastning?

\sv
Også her kan vi bruke \rref{progjen}. Vekstfaktoren er 1,05, originalverdien er 15\,000 og antall endringer (tiden) er 8. Dermed er
\[ \text{ny verdi}=15\,000\cdot1,05^8\approx22\,162 \]
Etter 8 år er det forventet at investeringen er verdt 22\,162\enh{kr}.
}
\vsk

\info{Spare med innskuddsrente eller aksjefond?}{
Som regel er forventet avkastning på et aksjefond høyere enn innskudsrenten du får i en bank, men ulempen er at forventet avkastning ikke gir noen garantier. Forventet avkastning oppgir bare økningen noen antar vil skje. Er du heldig blir økningen høyere, er du uheldig blir den lavere, og kan til og med føre til en \textsl{reduksjon} av investeringen din. I verste fall, rett nok i ekstremt sjeldne tilfeller, kan hele investeringen din ende opp med å bli verdt 0\enh{kr}. \vsk

Innskuddsrenten kan også forandre seg noe med tiden, men vil så og si aldri føre til en reduksjon av investeringen din.
}
\begin{comment}
...
\prbxl{0.66}{blant annet få fradrag hvis man betaler \outl{fagforeningskontingent} eller har gitt penger til veldedige formål.}\qquad
\prbxr{0.24}{Fagforeningskontingent er det du betaler for å være med i en \net{https://no.wikipedia.org/wiki/Fagforening}{fagforening}.}\regv
...
\newpage
\eks{
Bruttolønnen til Magnus er 500\,000\,kr. Han får 56\,000\,kr i personfradrag og 97\,600\,kr i minstefradrag, i tilleg betaler han 1\,000\,kr for årlig medlemskap i fagforeningen \textsl{Tekna}.\os
...
\begin{center}
	...
	\phantom{xxxxx}	& 500\,000 & bruttolønn*	\\
		...
		$ - $& 1\,000 &fagforeningskontingent* \\ \hline
		$ = $ &345\,400 & skattegrunnlag* \\ \hline
	\end{tabular}
\end{center}
$23\%\text{ av 345\,000}=79\,350 $. Magnus må betale $79\,350\enh{kr}$ i skatt.
}
...
Siden Line er over 69 år, skal hun betale 5,1\% trygdeavgift:
...
Det du sitter igjen med etter å ha betalt skatt, trygdeavgift og fagforeningskontingent kalles \textit{nettolønnen}. Med tanke på de tre tidligere delseksjonene kan vi sett opp et regnestykke som dette: \regv
\reg[Nettolønn]{
\begin{center}\vsb
	\begin{tabular}{c r}
...
Embla har altså 397\,859\,kr i nettolønn.
}
...
\begin{itemize}
	\item Hun tar på seg kveldsvakter på et gamlehjem. Av dette forventer hun ca. 4\,000\enh{kr} i nettolønn. \\
...
\newpage
\subsection{Regnskap}
I et budsjett fører man opp \textsl{forventede} inntekter og utgifter, mens i et \textit{regnskap} fører man opp \textsl{faktiske} inntekter og utgifter. Forskjellen mellom budsjett og regnskap kalles \textit{avviket}. For avviket er det vanlig at man for inntekter og resultat regner ut '$ {\text{regnskap}-\text{budsjett}} $', mens man for utgifter regner ut '$ \text{budsjett}-\text{regnskap} $'. Dette fordi vi ønsker positive tall hvis inntektene er større enn forventet, og negative tall hvis utgiftene er større enn forventet. \regv
\eks{ I eksempelet fra forrige delseksjon (\ref*{budsjett}) satt vi opp et månedsbudsjett for Lisa.
	...
	\begin{center}
		\begin{tabular}{r r r r}
			...
			\textit{Sum} & 8\,360 & 9\,860 & 1\,500\\\hline 
			& \\
			\textbf{Utgifter} & \\ \hline
			Mat & 4\,500 & 4\,200 & 300\\
			Klær, fritid o.l. & 1\,200 & 3\,600 & $ \color{red}-2\,400 $\\ \hline
			\textit{Sum} & 5\,700 & 7\,800 &$\color{red} -2\,100$\\ \hline
			& \\ \hline
			\textbf{Resultat}  & 2\,660 & 2\,060 & $ \color{red}-600 $ \\ \hline
		\end{tabular}
	\end{center}
Lisa gikk altså med 2\,060\,kr i overskudd, men 600\,kr mindre enn forventet ut fra budsjettet. 	
}
