...
For å finne brøkdelen av eit tal, gongar vi brøken med talet.\os
...
\eks[3]{
	...
	\sv
	(Sjå \mb\,for korleis dele tal med 100)
	\abc{
...
\info{Tips}{Å dele med 100 er såpass enkelt, at vi gjerne kan uttrykke prosenttal som desimaltal når vi gjer utrekningar. I \textsl{Eksempel 6} over kunne vi ha rekna slik:
...
\parbox[l][][l]{0.75\linewidth}{
	I ein butikk kosta ei skjorte først 500\enh{kr} , men selgast no med 40\% rabatt. \os
...
\eks[2]{Ein sjokolade kostar 9,80\enh{kr}, ekskludert mva. På matvarer er det 15\% mva.
	\abc{
\item Kva er vekstfaktoren for prisen på sjokoladen med mva. inkludert?	
...
Når ein skal finne ei prosentvis endring, er det viktig å vere klar over at det er snakk om prosent \textsl{av ei heile}, som er sjølve utgangspunktet for utrekningane. Denne heila er den originale verdien. \vsk
...
\eks[1]{
	I 2019 tente du 12\,000\enh{kr} og i 2020 tente du 10\,000\enh{kr}. Beskriv den prosentvise endringa i inntekta di, med inntekta i 2019 som utganspunkt.
...
\eks{
	I skule- og jobbsamanheng viser \textit{fråværet} til kor mange elevar/ansatte som ikkje er til stades.\os
	
	Ein dag var 5\% av elevane på ein skule ikkje til stades. Dagen etter var 7,5\% av elevane ikkje til stades.
\abc{
