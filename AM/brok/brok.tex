...
I \mb\;(s. 35\,-\,47) har vi sett hvordan brøker er definert ut fra en inn-\\deling av 1. I hverdagen bruker vi også brøker for å snakke om inndelinger av en helhet: \vs
\begin{figure}
	\centering
...
\spr{
Verdien til et prosenttall kalles noen ganger \outl{prosentfaktoren}.
}
\newpage
\info{Omgjøring av brøker til prosenttall}{
Alle brøker har en verdi, og alle verdier kan vi skrive om til en brøk med 100 i nevner. For eksempel er ${890=\frac{89\,000}{100}}$ og ${0,125=\frac{12,5}{100}}$ (forklar for deg selv hvorfor!). Dette kan vi utnytte for å skrive om brøker til prosenttall.
}
\eks[5]{
...
Alle regler om prosentregning kan også brukes ved promilleregning så lenge man erstatter 100 med 1000.
}
\newpage
