...
\eksop{GV25D2}{gv25d2opg2}
Et par sokker koster 80 kroner til full pris. Tabllen viser fire forskjellige tilbud. Finn tilbudet som gir lavest pris per sokkepar. 
\begin{center}
...
\eksop{GV22D1}{gv22d1}
\fig{gv22d1opg2}
Ta utgangspunkt i grafen. Vurder om påstandene er riktige eller ikke.
\begin{center}
	\small
\begin{tabular}{|l | c | c|}
	\hline
	& Korrekt & Ikke korrekt \\ \hline
	Om farten er 40 km/h, er bremselengden & & \\
	omtrent 8 m & &\\ \hline
	For at bremselengden skal være mindre enn  & & \\
	15 m, må farten være mindre enn 55 km/h & & \\ \hline
	Om farten halveres, halveres & & \\
	også bremselengden & &\\ \hline
	Om farten er over 70 km/h, er & & \\
	bremselengden  over 30 m  & & \\ \hline
\end{tabular}
\end{center}

\newpage
\eksop{GV22}{gv22d1opg4}
Kristian lager esker av papirkvadrater med sidelengde 10 cm. \os
I hvert hjørne klipper han bort et lite kvadrat med\\ sidelengde 2,5 cm. \os
Deretter bretter han opp papiret langs de prikkete linjene, og\\ fester hjørnene med tape. \os
...
\newpage
\eksop{GV26}{gv26d1opg8}
\tagop{
	\#programmering \#prosentregning
}
Zara skal spare penger i banken. Hun har laget programmet \\ nedenfor for å beregne sparingen.
\abc{
	\item Forklar hva programmet regner ut.
	\item Hvor mye regner Zara med å ha i banken etter to år\\ med sparing?
}
\python{python/gv26d1opg8.py}
...
\eksop{GV26D2}{gv26d2}
Silje har fått et jobboppdrag.
Silje får tre forskjellige lønnstilbud å velge mellom:
\begin{center}
	\begin{tabular}{l| l}
		Tilbud 1 & 186 kroner i timen \\ \hline
		Tilbud 2 & 1000 kroner ved oppmøte + 50 kroner i timen \\ \hline
		Tilbud 4 &  1 krone ved oppmøte, og beløpet dobles hver time. \\
		& Tilbudet er beskrevet ved funksjon $f(x)=2^x$.
	\end{tabular}
\end{center}
Det er usikkert hvor lenge Silje skal jobbe, men hun skal bare jobbe hele timer, og ikke mer enn 12 timer.
\abc{
\item Lag en grafisk framstilling av de tre tilbudene i samme koordinatsystem.
\item Lag en oversikt over hvilke tilbud som gir høyest lønn for forskjellige tidsintervall. Grunngi svaret ditt.
}
