...
\op{opgvekfindfunk}
Linjen $\vec{l}$ går gjennom punktene $A$ og $B$. Finn uttrykket til $\vec{l}$. Skriv uttrykket på to måter. \os
\abch{
\item $A=(-2, 7)$ og $B=(3, -5)$
...
\op{vekskalparl}
Gitt $ \vec{u}=[a,b] $ og $ \vec{v}=[c, d] $. Vis at hvis $\angle(\vec{u}, \vec{v})=0^\circ $, gir \eqref{skal2} at
\[ ad-bc=0 \]
