...
\subsubsection{Vinkelen mellom to vektorer}
...
\info{\note}{
Visuelt sett er den største forskjellen mellom en funskjon $ f(x) $ og en vektorfunksjon $ \vec{v}(t) $ at grafen til $ f $ bare kan skjære et bestemt punkt én gang, mens grafen til $ \vec{v} $ kan skjære et bestemt punkt uendelig mange ganger.
}
...
\reg[\boldmath$ 2\times 2 $ determinanter]{Determinanten $ \det(\vec{u}, \vec{v}) $ av to vektorer $ {\vec{u}=[a, b] }$ og $ {\vec{v}=[b, c]} $ er gitt som
	\algv{
