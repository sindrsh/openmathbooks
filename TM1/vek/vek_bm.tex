...
\end{equation}
Det er også nyttig å merke seg at det må finnes to tall $ s $ og $ t $ slik at $ {\vec{u}=[tx_2, sy_2]} $. Hvis $ \vec{u}\parallel \vec{v}$, følger det av \eqref{parforkl} at $ {\frac{sx_2}{x_2}=\frac{ty_2}{y_2}}  $.
...
\reg[Sirkelligningen]{
Gitt en sirkel radius $ r $ og sentrum $ {S=(x_0, y_0)} $, og et pyn. Hvis punktet $ A=(x, y) $ ligger på buen til sirkelen, er
\nn{
(x-x_0)^2+(y-y_0)^2=r^2
}
