...
Mengden som utelukkende inneholder alle verdier $ x $ kan ha, er \outl{definisjonsmengden} til $ f $. Denne mengden skrives som $ D_f $. \vsk

Mengden som utelukkende inneholder alle verdier $ f $ kan ha når $ {x\in D_f} $, er \outl{verdimengden} til $ f $. Denne mengden skrives som $ V_f $. 
}
\eks[1]
{ \label{mengeks1}
