...
Mengden som utelukkende inneholder alle $ x $-verdier som kan anvendes i funksjonsuttrykket til $f$, er \outl{definisjonsmengden} til $ f $. Denne mengden skrives som $ D_f $. \vsk

Mengden som utelukkende inneholder alle $ f $-verdier for $ {x\in D_f} $, er \outl{verdimengden} til $ f $. Denne mengden skrives som $ V_f $. 
}
\eks[1]
{ \label{mengeks1}
...
En funksjon kan ha flere uttrykk som gjelder ved forskjellige vilkår. Da sier vi at funksjonen har \outl{delt forskrift}. La oss for eksempel definere en funksjon $ f(x) $ slik:
\alg{
