...
\eks[2]{
I uttrykket $ 0\ ?\  x\  ?\  1 $, erstatt \sym{?} med et ulikhetssymbol slik at uttrykket gjelder for alle $ {x\in M} $, og om 1 er inneholdt i $ M $.
\abc{
\item $ M = [0, 1] $
\item $ M = (0, 1] $
\item $ M = [0, 1) $
...
\newpage
\subsubsection{Funksjoner med vilkår}
