...
\abch{
	...
	\item Toppunkt $ \left(\frac{1}{2}, 0\right) $ og bunnpunkt $\left(-\frac{3}{2}, 8e^{-\frac{3}{2}}\right)$
}
...
\opr{opgfunkfinnf}
\abch{
	\item $f(x)=-\frac{20}{49}(x-3)(x+4)$
	\item $f(x)=-\frac{400}{121}(x-10)(x+1)$
	\item $f(x)=-\frac{9}{4}(x-8)(x-12)$
} 
...
\abch{
	...
	\item Vertikal: $x=0$, horisontal: $y=1$, skjæringspunkt: ingen
...
\grubr{1th24d2opg5} 
$a=\frac{3}{20}$, $b=\frac{7}{40}$, $c=-\frac{11}{10}$, $d=\frac{63}{10}$
...
\grubr{r1v24d2opg6}
$C=\left(\frac{2\sqrt{3}}{3}, \frac{8}{3}\right)$
