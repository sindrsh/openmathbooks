...
\begin{center}
	\small
	\begin{tabular}{c | c}
\rowcolor{gray!15}		\textbf{punkt/verdi} & \textbf{type} \\ \hline
\rowcolor{orange!10}		$ A=(-14, -1456) $ & absolutt bunnpunkt \\ \hline
\rowcolor{orange!10}		$ -14 $ & ekstremalpunkt; absolutt minimum \\ \hline
\rowcolor{orange!10}		$ -1456 $& absolutt minimum \\ \hline
...
\rowcolor{orange!10}		$ C=(-1, -286) $ & vendepunkt  \\ \hline
\rowcolor{orange!10}		$ -1 $ & infleksjonspunkt \\ \hline 
...
\rowcolor{orange!10}		$ E= (16, 884) $ & absolutt maksimum \\ \hline
\rowcolor{orange!10}		$ 16 $ & ekstremalpunkt; absolutt maksimumspunkt \\ \hline
\rowcolor{orange!10}		$ 884 $ & absolutt maksimum \\ \hline
...
\fork{\ref{monder}\,\monder}{
	Gitt $ f(x) $, hvor $ {f'\geq0} $ for $ {x\in[a, b]} $. La $ {x_1, x_2 \in(a, b)}$ og $ {x_2>x_1} $. Av middelverdisetningen\footnote{Se \refved{midsetn}} finnes det et tall $ {c\in(x_1, x_2)} $ slik at
	\alg{
