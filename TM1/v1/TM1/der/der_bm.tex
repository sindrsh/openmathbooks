...
\[ \vec{r}\,''(t)=\left(\vec{r}\,'\right)'=[f''(t), g''(t)] \]
}
\newpage
\eks[]{
Gitt vektorfunksjonen $\vec{r}(t)=[2t^2, 5+e^t]$.
\abc{
\item Finn $\vec{r}\,'(t)$.
\item Finn $\vec{r}\,''(2)$.
}
...
\sv
\abc{
\item Vi har at \[ \vec{r}\,'(t)=\left[(2t^2)', (e^t)'\right]=[4t, e^t] \]
\item Vi har at
\[ \vec{r}\,''(t)=\left[(4t)', (e^t)'\right]=[4, e^t] \]
Dermed er $\vec{r}\,''(2)=[4, e^2]$
}
}
