...
\begin{enumerate}[label=\roman*)]
	...
	\item Differansen fra punkt i) er ${-7x-4}$. Vi kan få leddet med den høyeste gradenen av $ x $ ved å multiplisere divisoren med $ -7 $. Vi skriver $ -7 $ til høyre for likhetstegnet, og subtraherer $ -7(x+5)=-7x-5 $. 
...
\spr{
	...
	Logaritmen med $ e $ som grunntall kalles den \outl{naturlige logaritmen}. \os
