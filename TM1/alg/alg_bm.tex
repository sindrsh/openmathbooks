...
\eks[2]{
Løs ulikheten
\[ \frac{(x-3)(x+1)}{x-4}>0 \] \vs
\sv
Vi setter $f=\frac{(x-3)(x+1)}{x-4}$, og lager et fortegnskjema:
\fig{fortgnskj3}
Skjemaet viser følgende:
\begin{itemize}
	...
	\end{center}
\end{itemize}
Altså er ${\frac{(x-3)(x+1)}{x-4}>0}$ for $ x\in(-2,3)\cup (4, \infty) $.\vsk

\mers{Siden ${x-4}$ kan være både positiv og negativ, kan vi ikke multiplisere ulikheten med denne faktoren (fordi vi ikke kan vite hvordan retningen på ulikhetstegnet endres).}
}
