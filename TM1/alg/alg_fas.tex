...
\opr{opgalgft}
\abch{
	\item Positiv for $x\in (-1, 2)\cup(7, \infty)$, negativ for $x\in(-\infty, -1)\cup (2, 7)$
	\item Positiv for $x\in(-\infty, -1)\cup(3, \infty)$, negativ for $x\in(-1, 3)$. Se løsningsforslag for fortegnsskjema.
}
...
\abchs{2}{
\item $x\in\left(-\frac{11}{2}, -5\right)\cup (-3, \infty)$
}
...
\opr{1tv26d1opg2}
\abch{
\item $x=2$ og $y=0$ eller $x=-3$ og $y=-5$
\selos
}
...
\abch{
	\item $ P=(x-3)(x-4)(x+7) $
	\item $ P=(x+1)(x+3)(x+5) $
	\item $ P=(x+1)(x+6)\left(2x+7\right) $
}
...
\opr{r1v26d1opg3}
\abch{
	\item $\lg 7<e^{3\ln 1}<\sqrt[4]{3^3}<\log_2 8$
	\item $5\lg b+2$ (eventuelt $\lg(100b^5)$)
}
...
\grubr{t1v26d1opg3}
$x=-4\quad\vee\quad x=\frac{1}{2}\quad\vee\quad x=2$
