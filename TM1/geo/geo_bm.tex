...
Gitt $ \angle BAC $. For et punkt $ P $ som ligger på \outl{halveringslinja} til vinkelen (blå linje i figuren), er
\begin{equation}
...
\regdef[Midtnormal]{
\outl{Midtnormalen} til $ AB $ (blå linje i figuren) står normalt på $AB$, og går gjennom midtpunktet til $ AB $.
\fig{midnorm0}
}
\newpage
\regdef[sin, cos og tan I]{
...
Midtnormalene til en trekant møtes i ett og samme punkt, som er sentrum i den \outl{omskrevne sirkelen} til trekanten. Hjørnene til trekanten ligger på buen til den omskrevne sirkelen.	
\fig{midnorm1a}
}

\reg[\innskrsirk \label{innskrsirk}]{
Halveringslinjene til vinklene i en trekant møtes i ett og samme punkt. Dette punktet er sentrum i trekantens \outl{innskrevne sirkel}, som tangerer hver av sidene til trekanten.
\fig{innskr1a}
}
