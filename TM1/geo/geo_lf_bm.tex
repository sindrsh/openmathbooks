...
\alg{
v &= 180^\circ-\angle CEB-\angle EBC \\
&= 180^\circ -(180^\circ - \angle BAC)-(45^\circ-\angle BAC) \\
&= 45^\circ
}
...
Vi setter $ \angle ADC=u $. Av \rref{perfvink} er $ \angle AOC=2\angle ADC $. Da $ \triangle AOC $ er likebeint $ (AO=CO) $, er dermed $ \angle OAC= 90-u $, og følgelig er $ \angle BAC=u $. Dette betyr at $ \triangle ABC $ og $ \triangle BDA $ har to vinkler som er parvis like store, og dermed er de formlike. Altså er
\alg{
