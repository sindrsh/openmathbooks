...
\spr{
Å gå mot en verdi fra høgre/venstre kalles også å gå mot en verdi ovenfra/nedenfra. \vsk

Hvis $\lim\limits_{x\to a} f(x)$ er et endelig tall, sier vi at \outl{grensen eksisterer}. Hvis den \textsl{ikke} er et endelig tall, sier vi at \outl{grensen ikke eksisterer}. Et krav for at en grense skal eksistere er altså at $\lim\limits_{x\to a}\neq \pm \infty$ og at $\lim\limits_{x^+ \to a}=\lim\limits_{x^-}\to a$.
}
\info{\note}{
