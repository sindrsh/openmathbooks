...
\newcommand{\grubrs}[1]{{\color{NavyBlue}gruble \ref{#1}}}
...
\newcommand{\midtrk}{Omskrevet sirkel}
...
\newcommand{\verdmengdgittint}{Definisjonsmengde på voksende/avtagende intervall}
